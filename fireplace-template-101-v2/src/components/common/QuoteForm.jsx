      ...
      {formSubmitted ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-2.5 text-black">
          <div className="grid grid-cols-2 gap-[8px]">
            <div>
              ...
              <input
                ...
                className={`w-full pl-3 py-2 bg-white border rounded-md outline-none placeholder:text-gray-600 ${
          ...
          <textarea
            ...
            onFocus={handleFirstInteraction}
            rows={3}
            className={`w-full pl-3 py-2 max-h-[75px] bg-white border rounded-md outline-none placeholder:text-gray-600 ${
