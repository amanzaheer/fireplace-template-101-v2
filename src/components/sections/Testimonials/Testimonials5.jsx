...
export default function Testimonials5({ content }) {
  ...
  return (
    <FullContainer id="testimonials" className="py-14 md:py-20 bg-stone-100">
      <Container className="mx-auto">
        <div className="w-full rounded-[20px] bg-[#D35400] px-6 py-10 md:px-10 md:py-12 lg:px-12 lg:py-14 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.25)] flex flex-col">
          <h2 className="text-center text-3xl sm:text-4xl md:text-[2.75rem] font-bold text-white tracking-tight leading-[1.15] px-1">
            {sectionTitle}
          </h2>
          ...
          >
            ...
            <blockquote className="text-center text-white/95 text-base md:text-lg leading-[1.75] font-normal max-w-3xl mx-auto mt-6 md:mt-8 px-1">
            ...
            <div className="mt-10 md:mt-12 flex flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-3 md:gap-4 min-w-0">
                ...
                <div className="text-left min-w-0">
                  ...
                  <p className="text-[10px] md:text-xs font-semibold tracking-[0.2em] text-white/90 uppercase mt-0.5">
                    Clients
                  </p>
                </div>
              </div>
