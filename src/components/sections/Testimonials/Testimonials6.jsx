    ...
    >
      <div className="w-full overflow-x-hidden">
        <div className="flex flex-col lg:flex-row lg:items-stretch lg:gap-0 min-h-[min(100%,420px)] lg:min-h-[400px] w-full">
          ...
          <aside
            className="w-full lg:w-[min(100%,440px)]  px-25px lg:flex-shrink-0 flex flex-col items-center text-center shadow-none "
            style={{ backgroundColor: ORANGE }}
          >
            <div className="flex flex-col flex-1 items-center justify-between w-full min-h-[300px] lg:min-h-full px-8 py-8 md:py-10 md:px-10">
              <Quote 
                className="w-14 rotate-180 text-[#f59402] h-14 md:w-16 md:h-16 mb-6 opacity-90 shrink-0 mx-auto"
                style={{ color: ORANGE_DEEP }}
                strokeWidth={1.5}
                aria-hidden
              />
              <h3 className="text-white font-bold text-2xl md:text-[1.65rem] leading-tight mb-5 max-w-[14ch] mx-auto">
                {orangeTitle}
              </h3>
              <StarRow className="justify-center mb-8" />
              <div className="mt-auto pt-4 w-full">
                <p className="text-white font-bold text-lg md:text-xl">{orangeAuthor}</p>
                <p className="text-white/95 text-xs md:text-sm font-semibold tracking-[0.2em] mt-2">
                  {orangeLabel}
                </p>
              </div>
          ...
          >
            <h2 className="text-center text-neutral-900 font-extrabold w-full text-2xl md:text-3xl lg:text-4xl mb-4 md:mb-5">
              {sectionTitle}
            </h2>
            <StarRow className="mb-6 md:mb-8 justify-center" />

            <div className="relative flex-1 overflow-hidden min-h-[220px] w-full max-w-full">
              <div
              ...
              >
                {testimonialsWithAvatars.map((testimonial, index) => (
                  <div
                    key={index}
                    className="flex flex-col items-center justify-between px-2 md:px-4 box-border shrink-0"
                    style={{ width: `${100 / n}%`, flexBasis: `${100 / n}%` }}
                  >
                    <p className="text-center text-neutral-900 text-sm md:text-base leading-relaxed w-full max-w-3xl mx-auto mb-8 md:mb-10">
                    ...
                    <div className="flex flex-col items-center gap-4 mt-auto w-full">
                      <div className="flex flex-col sm:flex-row sm:items-center items-center justify-center gap-3 sm:gap-4">
                        ...
                        <div className="text-center">
                          <p className="font-bold text-neutral-900 text-base md:text-lg leading-tight">
                            {testimonial.name}
                          </p>
