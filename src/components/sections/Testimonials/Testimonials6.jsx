...
import { Rubik, Inter, Lexend, Poppins } from "next/font/google";
    ...
    >
      <div className="w-full overflow-x-hidden">
        <div className="flex flex-col lg:flex-row lg:items-stretch lg:gap-0 min-h-[min(100%,420px)] lg:min-h-[400px] w-full">
          ...
          <div
            className= {`${lexend.className} w-full flex-1 min-w-0 flex flex-col items-center text-center relative border-0 border-l border-black/10 lg:rounded-none rounded-lg lg:rounded-tl-none lg:rounded-bl-none lg:rounded-tr-lg lg:rounded-br-lg px-6 py-8 md:px-10 md:py-10 min-h-[360px] md:min-h-[400px] shadow-none`}
