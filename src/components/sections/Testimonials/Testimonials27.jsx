                                                ...
                                                >
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div className="min-w-0 text-left">
                                                            <h3
                                                                className={`${archivo.className} text-[18px] font-extrabold leading-none text-black md:text-[20px]`}
                                                            >
                                                                {testimonial.name}
                                                            </h3>
                                                            <p
                                                                className={`${archivo.className} text-[12px] font-semibold uppercase tracking-widest text-black`}
                                                            >
                                                                Client
                                                            </p>
                                                        </div>
