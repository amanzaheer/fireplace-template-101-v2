...
function QuoteIcon({ className = "w-14 h-14 text-[#ee4545]" }) {
  return (
    <svg
...
export default function Testimonials10({ content }) {
  ...
  return (
    <FullContainer className="py-10 md:py-14 bg-black" id="testimonials">
      <Container className="mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-10">
          <div className="w-full lg:w-[240px] h-full shrink-0 text-white">
            <div className="mb-2">
              <QuoteIcon className="w-14 h-14 text-[#ee4545] rotate-180" />
            </div>
                  ...
                  {testimonialsWithAvatars.map((testimonial, index) => (
                    <div key={index} className="testimonial-slide px-2 md:px-3">
                      <div className="bg-transparent overflow-hidden rounded-t-[14px] rounded-b-none">
                        ...
                        <div className="bg-[#ee4545] px-3 py-2.5 md:py-3">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <h3 className={`${archivo.className} text-white font-extrabold text-[18px] md:text-[20px] leading-none`}>
                                {testimonial.name}
                              </h3>
                              <p className={`${archivo.className} text-white/80 text-[12px] font-semibold uppercase tracking-widest`}>
                                Clients
                              </p>
                            </div>
                          </div>
