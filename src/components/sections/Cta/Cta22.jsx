  ...
  return (
    ...
    >
      <Link
        ...
        className={
          linkClassName ??
          "inline-flex h-[73.33px] w-[258px] shrink-0 flex-col items-center justify-center rounded-[15px] bg-[#ffffff] pt-[2.72px] pr-[1.36px] pb-[2.72px] pl-[1.36px] text-center shadow-md transition hover:cursor-pointer"
        }
      >
        <p
...
export default function Cta({ content }) {
  ...
  return (
    <FullContainer id="cta" className="bg-[#f0520e] py-10 md:py-12 lg:py-14 ">
      ...
      <Container className="px-4 sm:px-6 lg:px-8">
        <div className="mx-auto flex max-w-6xl flex-col items-stretch gap-8 lg:flex-row lg:items-center lg:justify-between lg:gap-10">
          <div className="min-w-0 flex-1 text-center lg:text-left">
            ...
            {description ? (
              <p className="mt-3 font-barlow text-base font-normal leading-relaxed text-white sm:mt-4 sm:text-lg md:text-xl">
                {description}
              </p>
            ) : null}
          </div>
