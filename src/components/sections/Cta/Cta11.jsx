...
import { ArrowRight, Lock, Phone, Smartphone } from "lucide-react";
...
export default function Cta11({ content }) {
  ...
  return (
    ...
    >
      <div className="relative w-full self-stretch min-h-[420px] md:min-h-[520px] lg:min-h-[560px]">
        ...
        />
        <div
          className="absolute inset-0 z-1 bg-[linear-gradient(180deg,rgba(172,120,43,0.78)_0%,rgba(172,120,43,0.66)_45%,rgba(0,0,0,0.54)_100%)]"
          aria-hidden
        />
        <div
        ...
        >
          <div className="flex flex-1 flex-col items-center justify-center px-4 py-14 md:px-8 md:py-20">
            ...
            {primaryCta ? (
                <button
                  ...
                  className="inline-flex h-[56px] min-w-[20px] items-center justify-center gap-3 rounded-none  px-4 text-center text-[31px] font-bold uppercase leading-none tracking-tight text-white transition-colors hover:bg-[#c98d2f] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white md:min-w-[300px]"
                >
                  {primaryCta}
          ...
          {showStrip ? (
            <div className="flex w-full shrink-0 justify-center  py-5">
              <Container className="mx-auto flex  max-w-[376px] justify-center h-[79px] font-Rubik font-semibold mb-10 px-4 sm:px-6 lg:px-8  bg-[#EFA536]">
                <div
                  className={cn(
                    "mx-auto flex w-10px  flex-col flex-wrap items-center justify-center gap-6 text-center text-[24.4px] font-normal ,leading-[140%] text-white md:flex-row md:items-center md:justify-center md:gap-10 lg:gap-16",
                  )}
                >
                  {licensedLabel ? (
                    <div className="flex max-w-full items-center justify-center gap-3 text-center">
                      <Lock
                        className="h-6 w-6 shrink-0 text-[#AC782B]"
                        strokeWidth={2}
                        aria-hidden
                      />
                  ...
                  {phoneDisplay ? (
                    ...
                    >
                      <Phone
                        className="h-6 w-2 shrink-0 text-[#AC782B]"
                        strokeWidth={2}
                        aria-hidden
                      />
                      <span>{phoneLine}</span>
