...
export default function Cta20({ content }) {
  ...
  return (
    <FullContainer id="cta" className="bg-[#FFFFFF] py-8 md:py-10">
      <Container>
        <div className={`mx-auto w-full max-w-[1280px] rounded-[28px] bg-[#d63232] px-6 py-8 text-center md:px-10 md:py-10 ${poppins.className}`}>
          {title ? (
          ...
          <div className="mt-5 flex flex-wrap items-center justify-center gap-3 md:gap-4">
            <Link
              href={phoneHref}
              className="inline-flex h-[56px] min-w-[170px] items-center justify-center gap-2 rounded-full border-2 border-white bg-[#d63232] px-7 text-[30px] font-semibold leading-none text-white transition-colors hover:bg-[#be2b2b]"
            >
            ...
            <button
              ...
              className="inline-flex h-[56px] min-w-[220px] items-center justify-center rounded-full bg-white px-8 text-[30px] font-semibold leading-none text-[#d63232] transition-colors hover:bg-[#f6f6f6]"
            >
              {secondaryCta}
            </button>
          </div>
