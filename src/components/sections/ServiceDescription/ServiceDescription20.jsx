...
export default function ServiceDescription20({ content }) {
  const block =
    content?.service_description && typeof content.service_description === "object"
    ...
    >
      <Container className="relative mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-[32px] border border-white/80 bg-white shadow-[0_24px_60px_rgba(15,23,42,0.12)] ring-1 ring-black/[0.04]'">
          <div className="absolute inset-x-0 top-0 h-1.5 bg-[#BF1309]" />
          ...
          <div className="grid grid-cols-1 gap-0 lg:grid-cols-12">
            {title ? (
              <div className="relative flex flex-col justify-center border-b border-neutral-200/90 bg-gradient-to-b' from-[#fafcff] to-white px-6 py-10 md:px-10 lg:col-span-4 lg:border-b-0 lg:border-r lg:py-14 lg:pl-12 lg:pr-8">
                <div
                  className="absolute left-0 top-12 bottom-12 hidden w-1 rounded-full bg-[#3A5FB6] lg:block"
                  aria-hidden
                />
                <h2
            ...
            >
              ...
              <div className="mt-8 flex flex-col gap-3 border-t border-neutral-200/90 pt-8 sm:flex-row sm:flex-wrap sm:items-center">
                {phone ? (
                  <div className="[&_button]:!h-[48px] [&_button]:!min-w-[180px] [&_button]:!rounded-xl [&_button]:!border-0 [&_button]:!bg-[#3A5FB6] [&_button]:!px-6 [&_button]:!py-2.5 [&_button]:!text-[15px] [&_button]:!font-semibold [&_button]:!text-white [&_button]:!shadow-md [&_button]:!shadow-[#3A5FB6]/30 [&_button]:transition [&_button]:hover:!bg-[#2d4d9e] [&_svg]:!h-5 [&_svg]:!w-5 [&_svg]:!text-white">
                    <PrimaryPhone phone={phone} />
                  </div>
                ) : null}
                <div className="[&_button]:!h-[48px] [&_button]:!min-w-[170px] [&_button]:!rounded-xl [&_button]:!border-0 [&_button]:!bg-[#BF1309] [&_button]:!px-6 [&_button]:!py-2.5 [&_button]:!text-sm [&_button]:!font-semibold [&_button]:!uppercase [&_button]:!tracking-wide [&_button]:!text-white [&_button]:!shadow-md [&_button]:!shadow-[#BF1309]/25 [&_button]:transition [&_button]:hover:!bg-[#a61008]">
