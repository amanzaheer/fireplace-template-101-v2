            ...
            <div className="space-y-4 order-2 md:order-1">
              ...
              {phone ? (
                <div className="flex flex-col sm:flex-row gap-3 pt-2">
                  <a
                    href={`tel:${phone}`}
                    className="inline-flex max-w-full items-center justify-center gap-2 bg-[#f59e0b] text-white uppercase tracking-wide font-bold px-7 py-3 text-sm hover:bg-[#111827] transition-colors duration-200"
                  >
                    Call Us Today
                  ...
                  <a
                    href={`tel:${phone}`}
                    className="inline-flex max-w-full items-center justify-center gap-2  bg-black  text-white font-bold px-6 py-3 text-base hover:bg-[#bf1f1f] transition-colors duration-200"
                  >
