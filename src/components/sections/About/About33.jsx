...
export default function About33({ content }) {
      ...
      <Container className=" mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-[1.04fr_1fr] gap-8 md:gap-10 lg:gap-24 items-start h-full">
          <div className="relative order-2 lg:order-1  mt-14">
              ...
              {image ? (
                <div className="absolute right-0 top-0 hidden h-[215px] w-[215px] translate-x-1/3 translate-y-1/3 overflow-hidden border-5 border-white  sm:block">
                  <Image
          ...
          <div className="order-1 lg:order-2 h-full py-8">
            <p className={`${poppins.className} text-[24px] md:text-[20px] font-normal tracking-wide text-black mb-2`}>
              {label}
            </p>
            <h2 className={`${poppins.className} text-[32px] sm:text-[36px] md:text-[44px] font-bold leading-[0.95] text-black mb-3`}>
              {heading}
            </h2>

            <p className={`${poppins.className} text-sm md:text-[16px] leading-normal text-black`}>
              {description1}
            </p>
            {description2 ? (
              <p className={`${poppins.className} mt-3 text-sm md:text-base lg:text-lg leading-normal text-black`}>
                {description2}
              </p>
            ) : null}
            ...
            <a
              ...
              className={`${poppins.className} mt-4 inline-flex h-[54px] w-[206px] items-center gap-2 rounded-[44px] bg-[#da4909] px-3 py-2 text-white`}
            >
