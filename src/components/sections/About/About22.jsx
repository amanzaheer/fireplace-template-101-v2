...
export default function About22({ content }) {
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-[1.02fr_1fr] lg:items-center">
          <div className="order-2 lg:order-1">
            <div className="grid grid-cols-1 gap-3">
              <div className="relative h-[260px] w-full overflow-visible border border-[#d9d9d9] bg-white md:h-[380px] md:w-[530px]">
                ...
                <span className="absolute right-0 top-1/2 z-20 flex h-14 w-14 translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-ehite">
                  <span className="flex h-9 w-9 items-center justify-center rounded-full bg-[#f0520e]">
            ...
            <div className="mt-3 grid grid-cols-[1fr_auto] gap-1">
              ...
              <div className="hidden h-[220px] w-[134px] items-center justify-center  bg-[#f0520e] text-center text-white md:flex">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-[38px] font-extrabold uppercase leading-[1.05] text-black md:text-[52px]">
              {headingPrimary}
              <br />
              <span className="text-[#f0520e]"> {headingAccent}</span>
            </h2>
            ...
            <div className="mt-5 grid grid-cols-1 gap-3 border-b border-[#f0520e] pb-4 md:grid-cols-2">
              {featureItems.map((feature, index) => (
                <div key={`${feature}-${index}`} className="flex items-center gap-2">
                  <ShieldCheck
                    className="h-5 w-5 shrink-0 text-[#f0520e]"
                    strokeWidth={2.3}
                  />
            ...
            <div className="mt-4 flex items-center gap-4">
              <span className="flex h-16 w-16 items-center justify-center rounded-full bg-[#f0520e] text-white">
              ...
              <div>
                ...
                {phone ? (
                  <a
                    href={`tel:${phone}`}
                    className="text-[24px] font-bold font-roboto leading-tight text-[#f0520e]"
                  >
                    {phone}
                  </a>
                ) : null}
