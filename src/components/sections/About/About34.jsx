...
export default function About34({ content }) {
    ...
    return (
        <FullContainer className=" py-10 md:py-14" id="about">
            <Container className="max-w-6xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-8 lg:gap-10 items-center">
                    ...
                    <div className="order-1 lg:order-2">
                        <p className={`${poppins.className} text-lg md:text-2xl font-medium tracking-normal text-[#F10508] leading-tight mb-2`}>
                            {label}
                        </p>
