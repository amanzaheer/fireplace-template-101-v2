...
export default function About30({ content }) {
    ...
    return (
        ...
        >
            <Container className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                {introHtml ? (
                    <div
                        className="mx-auto mt-4 max-w-[980px] text-center font-barlow text-base leading-[1.55] text-black font-normal md:mt-5 md:text-lg [&_a]:font-medium [&_a]:text-neutral-900 [&_a]:underline [&_p]:mb-3 [&_p]:leading-[1.55] [&_p]:last:mb-0 [&_strong]:font-bold"
                        dangerouslySetInnerHTML={{ __html: introHtml }}
                    />
                ) : null}

                {cardHtml || imageSrc ? (
                    <div className="mx-auto mt-8 max-w-6xl overflow-hidden rounded-2xl bg-[#CF1F21] shadow-[0_20px_48px_rgba(0,0,0,0.14)] md:mt-9 lg:mt-10">
                        <div className="flex flex-col lg:min-h-[235px] lg:flex-row lg:items-stretch">
                            ...
                            <div
                                className={`relative order-1 w-full shrink-0 lg:order-2 ${cardHtml
