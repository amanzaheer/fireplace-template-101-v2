...
export default function ServiceCities26({ content }) {
    ...
    <FullContainer className="py-10 md:py-14 bg-[#ffffff]" id="locations">
      <Container className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 gap-x-2 gap-y-2.5 sm:grid-cols-3 sm:gap-x-3 md:gap-x-5 md:gap-y-3 lg:grid-cols-6">
            {cities.map((city, index) => (
              <div
                key={index}
                className="inline-flex min-w-0 items-center gap-1.5 rounded-[1px] bg-[#f2f2f2] px-1.5 py-1 shadow-[0_2px_2px_0px_rgba(0,0,0,0.2)] sm:px-2"
              >
                <svg
                  width="18"
                  height="18"
                ...
                <span className={`${inter.className} min-w-0 truncate text-[12px] font-normal leading-tight text-[#000000] sm:text-[14px] md:text-[16px]`}>
