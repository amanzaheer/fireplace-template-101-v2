...
const CARD_ICONS = [Settings2, Users, Monitor, Smartphone, Database, Layers, ShieldCheck, Phone];
  ...
  return (
    <article
      className={cn(
        ...
        cardTransition,
        "hover:bg-[#D32F2F] hover:duration-800 hover:shadow-[0_14px_32px_rgba(211,47,47,0.35)]",
      )}
    >
      <div
        className={cn(
          "mb-5 flex h-14 w-14 items-center justify-center rounded-[10px] bg-[#D32F2F] text-white",
          cardTransition,
          "group-hover:bg-white group-hover:text-[#D32F2F]",
        )}
      >
        <Icon
      ...
      <h3
        className={cn(
          "mb-3 text-lg font-bold leading-snug text-black sm:text-xl",
          cardTransition,
    ...
    >
      <Container className="px-4 sm:px-6 lg:px-8">
        <div className="mx-auto ">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-3 pt-10 sm:flex-row md:mt-14">
            {ctaLabel ? (
              <button
                type="button"
                onClick={scrollToQuote}
                className="inline-flex h-12 w-full min-w-0 max-w-full items-center justify-center gap-2 rounded-2xl bg-[#D32F2F] px-4 text-sm font-semibold text-white shadow transition hover:bg-[#b82929] sm:w-[220px] sm:max-w-[220px]"
              >
                {ctaLabel}
