          ...
          <div className="bg-white  shadow-sm border border-[#e5e7eb] p-6 md:p-10  rounded">
            ...
            {phone ? (
              <div className="flex flex-col sm:flex-row gap-3 justify-center items-center pt-8 mt-2 border-t border-[#e5e7eb]">
                <a
                  href={`tel:${phone}`}
                  className="inline-flex max-w-full items-center justify-center gap-2 rounded bg-[#040404] text-white uppercase tracking-wide font-bold px-7 py-3 text-sm hover:bg-[#111827] transition-colors duration-200"
                >
                  Call Us Today
                ...
                <a
                  href={`tel:${phone}`}
                  className="inline-flex max-w-full items-center justify-center gap-2  rounded bg-[#023e8a] text-white font-bold px-6 py-3 text-base hover:cursor-pointer transition-colors duration-200"
                >
