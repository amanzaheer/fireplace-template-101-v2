      ...
      <Container>
        ...
        <div className="relative mx-auto max-w-[1450px]">
          <div className="relative overflow-hidden py-3">
            {/* Top Curve */}
            <div className="pointer-events-none absolute -top-[120px] left-1/2 z-20 h-[170px] w-[135%] -translate-x-1/2 rounded-[100%] bg-[#ffffff]" />

            {/* Bottom Curve */}
            <div className="pointer-events-none absolute -bottom-[120px] left-1/2 z-20 h-[170px] w-[135%] -translate-x-1/2 rounded-[100%] bg-[#ffffff]" />
            ...
            <div className="overflow-x-auto overflow-y-hidden overscroll-x-contain [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
              <div className="mx-auto flex min-w-full items-center justify-center gap-3 px-1 py-2 md:gap-5 lg:gap-6">
          ...
          {stats.slice(0, 4).map((item, idx) => (
            <div key={`stat-${idx}`} className="text-center">
              <div className="flex items-center justify-center gap-1">
                <span
                  className={`${montserrat.className} text-[68px] font-bold leading-none text-[#060606] md:text-[60px]`}
                >
                  {item?.value ?? "0"}
                </span>
              ...
              <p
                className={`${poppins.className} mt-2 text-[20px] font-medium  text-[#222] md:text-[12px] lg:text-[15px]`}
              >
                {item?.label ?? ""}
              </p>
            </div>
