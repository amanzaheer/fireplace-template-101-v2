...
export default function Footer27({ content }) {
    ...
    return (
        <footer className="font-barlow text-white antialiased border">
            <FullContainer id="footer" className="mb-16 bg-white py-10 md:mb-0 md:py-12">
                <Container className="max-w-6xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-start sm:gap-12 md:gap-16">
                        <div className="shrink-0">
                            {navbar?.logo ? (
                                <Logo
                                    ...
                                    className="font-serif font-bold text-black md:text-2xl lg:text-[1.65rem]"
                                />
                            ) : brandName ? (
                                <>
                                    <p className="font-montserrat text-2xl font-bold tracking-tight text-black md:text-3xl">
                                        {brandName}
                                    </p>
                                    {navTagline ? (
                                        <p className="mt-1 text-base text-black/90">{navTagline}</p>
                                    ) : null}
                                </>
                            ) : null}
                        </div>
                        ...
                        {footerNav.length > 0 ? (
                            <nav
                                className="flex flex-wrap items-center justify-start gap-x-5 gap-y-2 text-sm  ml-34 text-black md:gap-x-10 md:text-[17px]"
                                aria-label="Footer"
                            >
                    ...
                    <div className="mt-10 grid gap-10 md:grid-cols-2 md:gap-12 lg:max-w-[860px]">
                        <div className="flex min-w-0 flex-col">
                            {description ? (
                                <p className="max-w-[350px] text-[15px] leading-relaxed text-black md:text-base">
                                    {description}
                                </p>
                            ) : null}
                            ...
                            {phone ? (
                                <Link
                                    href={telHref(phone)}
                                    title="Call now"
                                    className="mt-8 inline-flex max-w-full items-center gap-4  h-[50px] rounded-md bg-[#FF0011] px-5 py-3 text-white shadow-lg shadow-black/25 transition hover:brightness-95n w-fit sm:w-fit sm:max-w-md"
                                >
                        ...
                        <div className="flex w-full flex-col items-start justify-start">
                            <h3
                                className={`${rubik.className} mb-5 w-full text-left text-lg font-bold text-black md:text-[25px]`}
                            >
                                Stay Tuned With Us
                            </h3>
                            <div className="flex w-full flex-col items-start gap-2 text-left md:gap-3">
                                <div className="flex w-full items-start gap-3">
                                    <div className="flex min-w-0 items-center gap-1.5 text-left">
                                        ...
                                        />
                                        <span className="text-left text-sm text-black md:text-[15px]">
                                            {workingHours}
                                        </span>
                                    </div>
                                </div>
                                <div className="flex w-full items-center justify-start gap-3 text-left">
                                    ...
                                    <Link
                                        href={`mailto:${email}`}
                                        className="min-w-0 wrap-break-word text-left text-[17px] text-black/95 transition-colors duration-200 hover:text-black"
                                    >
                                        {email}
                                    </Link>
                                </div>
                                <div className="flex w-full items-center justify-start gap-3 text-left">
                                    ...
                                    <Link
                                        ...
                                        className="text-left text-[17px] text-black transition-colors duration-200"
                                    >
                                        {phone}
                                    </Link>
                                </div>
