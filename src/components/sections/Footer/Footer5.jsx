...
export default function Footer5({ content }) {
  ...
  return (
    <footer>
      <FullContainer id="footer" className="bg-black py-8 md:py-12 mb-16 md:mb-0 relative overflow-hidden">
        <Container className="relative z-10">
          <div className="rounded-sm bg-black/85 px-5 py-6 md:px-10 md:py-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 justify-between w-full">
              ...
              <div className="w-full md:max-w-[460px] md:ml-auto">
                ...
                <ul className="space-y-3 md:space-y-4 mt-2">
                  ...
                  <li className="flex items-start gap-3">
                    <Clock4 className="w-4 h-4 text-amber-500 mt-1 shrink-0" />
