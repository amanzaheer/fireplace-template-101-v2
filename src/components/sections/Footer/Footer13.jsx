...
export default function Footer13({ content }) {
              ...
              >
                {footerNav.map(({ label, href }) => (
                  <Link
                    key={label}
                    href={href}
                    className="transition-colors hover:text-[#CDE02E]"
                  >
                    {label}
                  </Link>
                ))}
            ...
            <div className="flex min-w-0 flex-col">
              ...
              {phone ? (
                <Link
                  href={telHref(phone)}
                  title="Call now"
                  className="mt-8 inline-flex max-w-full items-center gap-4  h-[50px] rounded-full bg-[#CDE02E] px-5 py-3 text-white shadow-lg shadow-black/25 transition hover:brightness-95n w-fit sm:w-fit sm:max-w-md"
                >
