...
const LeafletMap = dynamic(
  async () => {
    ...
    const mapPin = L.divIcon({
      html: `
        <div style="display:flex;align-items:center;justify-content:center;width:18px;height:18px;border-radius:9999px;background:#D32F2F;color:#fff;font-size:11px;line-height:1;">•</div>
      `,
      className: "",
      iconSize: [18, 18],
      iconAnchor: [9, 9],
