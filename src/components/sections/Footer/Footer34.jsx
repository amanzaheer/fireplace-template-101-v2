...
export default function Footer34({ content }) {
    ...
    return (
        <footer>
            <FullContainer
                id="footer"
                className="bg-[#000000] py-12 md:py-19 mb-16 md:mb-0 relative"
            >
                <Container className={`relative z-10 ${archivo.className}`}>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12">
                        <div>
                            <p className="text-white/90 text-[17px] leading-relaxed max-w-[420px] p-4">
                                {statement}
                            </p>
                            ...
                            <div className="mt-6 flex items-center gap-3">
                                <a
                                    ...
                                    className={`${poppins.className} inline-flex flex-1 min-w-0 basis-1/2 h-[54px] items-center gap-2 rounded-[44px] bg-[#ff0504] px-8 py-4 text-white`}
                                >
                                    <span className="flex flex-col leading-none">
                                        <span
                                            className={`${poppins.className} text-[16px] font-normal uppercase tracking-[0.04em] text-white`}
                                        >
                                            Call Now:
                                        </span>
                                        <span
                                            className={`${poppins.className} mt-0.5 text-[17px] font-bold tracking-wide text-white whitespace-nowrap normal-case`}
                                        >
                                            {phone || "(888)-249-0566"}
                                        </span>
                                    </span>
                                ...
                                <button
                                    ...
                                    className={`${poppins.className} inline-flex flex-1 min-w-0 basis-1/2 h-[54px] items-center gap-2 rounded-[44px] bg-white px-3 py-2 text-black`}
                                >
                                    <span className="flex flex-col leading-none">
                                        <span
                                            className={`${poppins.className} text-[16px] font-normal uppercase tracking-[0.04em] text-black`}
                                        >
                                            Book Now:
                                        </span>
                                        <span
                                            className={`${poppins.className} mt-0.5 text-[20px] font-bold tracking-wide text-black normal-case`}
                                        >
                                            Appointment
                                        </span>
                                    </span>
                            ...
                            <ul className="space-y-2">
                                ...
                                <li className="relative" ref={servicesWrapRef}>
                                    ...
                                    >
                                        <FontAwesomeIcon
                                            icon={byPrefixAndName.fas["caret-right"]}
                                            className={`text-[16px] text-[#ff0504] transition-transform duration-200 ${isServicesOpen ? "-rotate-90" : "rotate-90"
                                                }`}
                                        />
                                        <span>Services</span>
                                    </button>
