...
export default function Footer7({ content }) {
  ...
  return (
    <footer>
      <FullContainer
        id="footer"
        className="bg-[#011126] py-6 md:py-9 mb-16 md:mb-0 relative"
      >
        {bgSrc ? (
          <Image
            title="Footer Image"
              ...
              <ul className="space-y-4 md:space-y-5">
                <li className="flex items-start gap-3.5">
                  <div className="w-6 h-auto whitespace-nowrap shrink-0 mt-1">
                    <Image
                      src="/st-icons/Temp7/location.png"
                      alt="Location"
                      width={16}
                      height={16}
                ...
                <li className="flex items-center gap-3.5">
                  <div className="w-5 h-auto whitespace-nowrap shrink-0">
                    <Image
                      src="/st-icons/Temp7/contact.png"
                      alt="Phone"
                      width={16}
                      height={16}
                      className="w-auto h-5 md:h-[19px]"
