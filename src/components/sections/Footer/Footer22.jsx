...
export default function Footer22({ content }) {
        ...
        <Container className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-10 md:flex-row md:items-start md:justify-between md:gap-16">
            <div className="flex min-w-0 flex-1 flex-col gap-6">
              {menuItems.length > 0 ? (
                <nav
                  className="flex flex-wrap items-center gap-x-5 gap-y-2 text-sm md:gap-x-13 md:text-[17px]"
                  aria-label="Footer"
                >
              ...
              {phone ? (
                <Link
                  href={telHref(phone)}
                  title="Call now"
                  className="inline-flex w-fit max-w-full items-center gap-4  h-14 bg-[#f0520e] px-5 py-3 text-white rounded-full shadow-lg shadow-black/30 transition hover:brightness-95"
                >
