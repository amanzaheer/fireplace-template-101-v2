...
export default function Footer29({ content }) {
              ...
              <ul className="space-y-4 md:space-y-5">
                <li className="flex items-start gap-3.5">
                  <div className="w-6 h-auto whitespace-nowrap shrink-0 mt-1">
                    <Image
                      src="/st-icons/Temp9/pin.png"
                      alt="Location"
                      width={16}
                      height={16}
                      className="w-auto h-5 md:h-[19px] text-[#EE4545]"
