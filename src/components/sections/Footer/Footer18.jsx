...
export default function Footer18({ content }) {
  ...
  return (
    <footer className="font-barlow text-white antialiased">
      <FullContainer
        id="footer"
        className="bg-[#000000] py-6 mb-16 md:mb-0"
      >
        <Container className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between">
            <div className="flex flex-col  ">
              ...
              <Link
                ...
                title="Call now"
                className="inline-flex max-w-full mt-4 mb-6 items-center gap-4 rounded-full bg-[#F0520E] w-fit px-3 py-2 text-white shadow-lg shadow-black/20 transition hover:brightness-95 sm:max-w-md"
              >
          ...
          <div
            className="my-4 h-px w-full bg-white "
            role="presentation"
          />
          <div className="flex justify-between items-center gap-10 pb-2 md:pb-0">
              ...
              <div>
                {navbar?.logo ? (
                  <Logo
                    ...
                    className="font-serif font-bold text-white md:text-3xl lg:text-[1.65rem]"
                  />
                ) : (
                  <>
