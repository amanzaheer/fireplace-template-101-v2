...
const variants = { Footer1, Footer2, Footer3, Footer4, Footer5, Footer8, Footer7, Footer9, Footer10 };
...
export default function Footer({ variant, content }) {
  ...
  export { Footer1, Footer2, Footer3, Footer4, Footer5, Footer8, Footer7, Footer9, Footer10, variants };
