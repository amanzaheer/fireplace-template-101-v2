...
const CallButton8 = memo(function CallButton8({ content }) {
  const phone =
    content?.phone || content?.navbar?.phone || content?.contact_info?.phone;
      ...
      <div className="w-full bg-gradient-to-b from-green-700 via-lime-600 to-green-600 rounded-md flex flex-col items-center justify-center py-3">
        ...
        >
          <div className="flex items-center mb-1">
            ...
            <div className="uppercase text-4xl font-extrabold">CALL US NOW</div>
          </div>
