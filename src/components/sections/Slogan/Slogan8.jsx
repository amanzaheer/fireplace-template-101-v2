  ...
  return (
    <FullContainer id="slogan" className="bg-[#f0f2f5] py-8 md:py-12 lg:py-16">
      <Container className="flex justify-center">
        <div className="w-full max-w-[1100px] rounded-2xl border border-black/[0.06] bg-white p-5 shadow-[0_8px_30px_rgba(0,0,0,0.08)] sm:p-7 md:p-9 lg:p-10">
          <div
          ...
          >
            ...
            >
              {title ? (
                <h2 className="font-montserrat mb-3 w-full max-w-[526px] text-[28px] font-bold leading-tight text-black not-italic sm:text-[36px] sm:leading-[44px] md:text-[40px] md:leading-[48px] lg:text-[44px] lg:leading-[53px]">
                  {title}
                </h2>
              ) : null}
              {description ? (
              ...
              {phone ? (
                <div className="[&_button]:!min-h-[48px] [&_button]:!rounded-lg [&_button]:!border-0 [&_button]:!bg-[#ff6600] [&_button]:!px-7 [&_button]:!py-3 [&_button]:!text-sm [&_button]:!font-bold [&_button]:!uppercase [&_button]:!tracking-wide [&_button]:!text-white [&_button]:!shadow-none [&_button]:hover:!bg-[#e65c00] [&_button]:!transition-colors [&_svg]:!text-white">
