...
export default function Slogan({ variant, content }) {
  const name = String(variant ?? "").trim() || "Slogan17";
  const Component = variants[name] ?? Slogan16;
  return <Component content={content} />;
}
export { Slogan1, Slogan2, Slogan3, Slogan4, Slogan6, Slogan5, Slogan8, Slogan7, Slogan9, Slogan15, Slogan11, Slogan12, Slogan14, Slogan10, Slogan13, Slogan17, Slogan19, variants };
