...
export default function OurServices29({ content }) {
                    ...
                    {displayServices.map((service, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex justify-center items-center flex-row relative z-10 -mt-12 mb-28 h-[71px]  w-[356px] rounded-tl-[30px] rounded-tr-[30px]  bg-[#FE4949] px-3 py-[10px] text-center">
                                    <h3
