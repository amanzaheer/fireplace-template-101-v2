...
export default function OurServices25({ content }) {
    ...
    return (
        <FullContainer id="our_services" className="bg-white py-12 md:py-16">
            <Container className=" max-w-5xl!">
                <div className="mb-8 flex items-center justify-center gap-4  text-black">
                    ...
                    {displayServices.map((service) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="relative z-10 -mt-6 bg-[#D90209] pt-3  pb-4 px-4 flex flex-col items-center rounded-[18px] rounded-b-none">
