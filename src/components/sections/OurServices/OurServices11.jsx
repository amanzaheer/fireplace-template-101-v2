...
const MAX_DISPLAY = 8;
export default function OurServices11({ content }) {
  ...
  return (
    <FullContainer id="our_services" className="bg-white py-10 md:py-14">
      <Container>
        <h2 className={`${poppins.className} text-3xl md:text-[44px] font-extrabold text-center text-[#2d2d2d] mb-8 md:mb-10 tracking-tight`}>
          {title}
        </h2>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-6 drop-shadow-md">
          {displayServices.map((service) => {
            return (
              ...
              >
                {/* Content */}
                <div className="col-span-2 flex flex-col  shadow-[0_2px-2px_10px_rgba(0,0,0,1)] flex-1 min-w-0 p-4 md:p-5 py-5 md:py-10  bg-white">
