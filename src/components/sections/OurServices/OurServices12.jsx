        ...
        <div className="grid grid-cols-3 md:gap-8 gap-4">
          {displayServices.map((service, index) => {
            ...
            return (
              <div
                key={service.id}
                className="bg-white  overflow-hidden  hover:shadow-lg transition-shadow duration-200 flex flex-col"
              >
                ...
                <div className="flex flex-col flex-1 p-3 md:p-6 pb-4">
                  <h3 className="md:text-[20px] font-semibold text-black mb-2 text-center">
