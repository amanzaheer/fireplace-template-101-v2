    ...
    <FullContainer className="bg-white py-10 md:py-16" id="our_services">
      <Container className="px-5 sm:px-6 md:px-8 lg:px-10">
        <div className="text-center  mb-8 md:mb-12">
          ...
          <h2 className={`${poppins.className} text-3xl md:text-4xl lg:text-[2.5rem] font-extrabold text-black tracking-tight leading-tight`}>
            {title}
          </h2>
        </div>

        <div className={`${poppins.className} flex w-full flex-wrap justify-center gap-6 md:gap-8`}>
          {displayServices.map((service) => {
            ...
            return (
              ...
              >
                <div
                  className={`${poppins.className} group relative w-full aspect-4/3 overflow-hidden rounded-xl bg-gray-100 shadow-md`}
                >
                  {imageSrc ? (
                    <Image
                      src={imageSrc}
                      ...
                      className={` ${poppins.className} object-cover transition-transform duration-500 group-hover:scale-105`} 
                      loading="lazy"
                      placeholder="blur"
                  ...
                  >
                    ...
                    <a
                      ...
                      className={` ${poppins.className} inline-flex items-center justify-center rounded-lg bg-[#F97316] px-6 py-2.5 text-base font-bold text-white shadow-md transition-colors hover:bg-[#ea580c] focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-black/50`}
                    >
                      Call Us
                    </a>
                  </div>
