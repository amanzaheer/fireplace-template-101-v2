...
export default function Breadcrumbs18({ content }) {
  ...
  return (
    <FullContainer className=" py-6 md:py-8 bg-black">
            ...
            {breadcrumbs.map((breadcrumb, index) => {
              ...
              return (
                <span key={`${breadcrumb.url}-${index}`} className="flex items-center gap-2">
                  ...
                  {isLast ? (
                    <span
                      className="text-[14px] font-semibold text-[#FF0011] md:text-[15px]"
                      aria-current="page"
                    >
                      {text}
                    </span>
                    ...
                    <Link
                      ...
                      className="text-[14px] font-bold text-[#415FB0] transition-colors hover:text-white"
                    >
                      {text}
                    </Link>
                  )}
