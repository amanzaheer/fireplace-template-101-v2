...
export default function Breadcrumbs20({ content }) {
            ...
            {breadcrumbs.map((breadcrumb, index) => {
              ...
              return (
                <span key={`${breadcrumb.url}-${index}`} className="flex items-center gap-2">
                  ...
                  {isLast ? (
                    <span
                      className="text-[14px] font-semibold text-red-500  md:text-[15px]"
                      aria-current="page"
                    >
                      {text}
                    </span>
                    ...
                    <Link
                      ...
                      className="text-[14px] font-bold text-[#415FB0] transition-colors hover:text-[#111111]"
                    >
                      {text}
                    </Link>
                  )}
