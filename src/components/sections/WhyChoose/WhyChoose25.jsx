...
import { Cta13CallNowButton } from "@/components/sections/Cta/Cta13";
...
export default function WhyChoose25({ content }) {
    const phone =
    ...
    return (
        <FullContainer id="whychooseus" className="bg-[#000000] py-14 md:py-20 lg:py-24">
            <Container className="px-4 sm:px-6 lg:px-0! max-w-[880px]">
                <div className="inline-flex w-full min-w-0 flex-col items-center gap-[53px] ">
                    <header className="mx-auto flex w-full max-w-3xl flex-col items-center text-center">
                        ...
                        {subheading ? (
                            <p
                                className={`${poppins.className}  text-xs font-normal leading-relaxed text-white sm:text-[13px] md:text-[16px]`}
                            >
                                {subheading}
                            </p>
                        ) : null}
                    ...
                    <div className="mx-auto w-full min-w-0 max-w-[1080px] self-stretch py-4">
                        <ul className="grid w-full min-w-0 list-none grid-cols-1 gap-6 self-stretch p-0 md:grid-cols-3 md:items-start md:gap-x-4 md:gap-y-7 lg:gap-x-6">
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="flex min-w-0 flex-1 flex-col items-stretch text-left">
                                            {title ? (
                                                <h3
                                                    className={`${rubik.className} text-base font-bold text-white sm:text-lg`}
                                                >
                                                    {title}
                                                </h3>
                                            ) : null}
                                            {description ? (
                                                <p
                                                    className={`${rubik.className} mt-1 text-sm font-normal leading-relaxed text-white sm:text-[16px] ${title ? "" : "mt-0 text-lg font-medium text-black sm:text-xl"
                                                        }`}
                                                >
                                                    {description}
                                                </p>
                        ...
                        <Cta13CallNowButton
                            phone={phone}
                            wrapperClassName="mt-10 flex w-full  justify-center md:mt-12"
                        />
