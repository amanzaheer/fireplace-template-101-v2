...
export default function WhyChoose26({ content }) {
        ...
        <div className="grid grid-cols-1 items-start  gap-1 md:grid-cols-2 md:items-stretch md:gap-2">
          ...
          >
                ...
                return (
                  <div key={idx} className="flex items-start  gap-3">
                    <div className="gap-1 h-8 w-8 shrink-0">
                      <Image
                        src="/st-icons/Temp12/shieldicon.png"
                        alt="icon"
                        width={32}
                        height={32}
            ...
            <a
              ...
              className="inline-flex h-auto min-h-[46px] w-[323px] shrink-0 items-center justify-center gap-2 rounded-full border-3 border-white bg-[#BF1309] px-6 py-[11px] font-normal uppercase tracking-wide text-white shadow-lg transition-opacity hover:opacity-95"
            >
