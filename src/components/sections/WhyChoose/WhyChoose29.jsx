...
const accentBtn =
    "inline-flex min-h-[48px] min-w-[205px] items-center justify-center gap-2 rounded-sm px-6 py-3 text-base font-semibold text-white shadow-md transition-opacity hover:opacity-90 focus-visible:outline-2 focus-visible:outline-offset-2";
...
export default function WhyChoose29({ content }) {
                                ...
                                <ul className={`${poppins.className} space-y-4 lg:pt-2`}>
                                    {lastFeatures.map((feature, idx) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                {IconComponent && (
                                                    <IconComponent className="mt-0.5 h-6 w-6 shrink-0 text-[#FE4949]" />
                                                )}
                                                <span>{text}</span>
                                            </li>
                                        );
