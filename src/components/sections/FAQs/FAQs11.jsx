...
export default function FAQs11({ content }) {
  ...
  return (
    <FullContainer className="py-10 md:py-14 bg-[#ffffff]" id="faqs">
              ...
              return (
                <div key={faq?.id ?? index} className="mb-4">
                  <button
                    type="button"
                    id={`faq-btn-${index}`}
                    className={`w-full text-left py-4 md:py-5 px-6 md:px-8  rounded flex items-start justify-between transition-colors duration-200 focus:outline-none ${
                      isOpen
                        ? "bg-[#efa536] text-white"
                        : "bg-[#f3f3f3] text-[#2d2d2d] hover:bg-[]"
                    }`}
                    onClick={() =>
