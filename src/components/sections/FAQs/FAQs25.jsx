...
export default function FAQs25({ content }) {
    ...
    return (
        <FullContainer className="bg-gradient-to-b from-[#BF1309] to-[#131314] py-10 md:py-14" id="faqs">
            <Container className="px-4 sm:px-6">
                <div className={`mx-auto max-w-6xl ${poppins.className}`}>
                    ...
                    <div className="grid items-start gap-0 lg:grid-cols-[420px_1fr] lg:gap-x-3 xl:grid-cols-[460px_1fr]">
                        {faqImageSrc ? (
                            <div className="relative mx-auto flex w-full max-w-full border-4 border-white items-center justify-center overflow-hidden  aspect-[4/5] md:max-w-md lg:mx-0 lg:h-[min(452px,48vh)] lg:w-full lg:aspect-auto">
                                <Image
                                    src={faqImageSrc}
                                        ...
                                        {isOpen ? (
                                            <div className="my-2 rounded-xl  p-4 shadow-md sm:my-3 sm:p-5 md:my-4 md:p-8">
                                                ...
                                                <div
                                                    ...
                                                    className="mt-3 border-t border-white pt-3 text-sm font-normal leading-relaxed text-white sm:mt-4 sm:pt-4 sm:text-base md:text-[17px]"
                                                >
                                                    {answer}
                                                </div>
                                            </div>
