...
export default function FAQs32({ content }) {
              ...
              return (
                <div key={faq?.id ?? index} className="mb-4">
                  <button
                    type="button"
                    id={`faq-btn-${index}`}
                    className={`w-full text-left py-4 md:py-5 px-6 md:px-8  flex items-start justify-between transition-colors duration-200 focus:outline-none ${
                      isOpen
                        ? "bg-[#f59402] text-[#212020]"
