...
export default function FAQs15({ content }) {
        ...
        <div className="grid grid-cols-1 items-start gap-6 lg:grid-cols-2">
          <div className="">
            ...
            <a
              ...
              className="mt-5 inline-block rounded-md bg-[#F39C12] px-6 py-3 font-montserrat text-lg md:text-2xl font-bold uppercase tracking-wide text-white transition hover:brightness-95"
            >
              Ask a question
            </a>
