...
import Contact15 from "@/components/sections/Contact/Contact15";
import { Contact18, Contact19 } from "../Contact";
        ...
        <div className="grid grid-cols-1 items-start gap-6 lg:grid-cols-2">
          <div className="">
            <div
              ...
              className="w-full "
            >
              <Contact19 content={content} embedded />
            </div>
          </div>
          ...
          <div className="">
            ...
            <a
              ...
              className="mt-5 inline-block rounded-md bg-[#F0520E] px-6 py-3 font-montserrat text-lg md:text-2xl font-bold uppercase tracking-wide text-white transition hover:brightness-95"
            >
              Ask a question
            </a>

            <div className="mt-7 space-y-2 border-neutral-300 bg-[#FFF0EA] gap-3 font-barlow">
                ...
                return (
                  ...
                  >
                    <button
                      type="button"
                      id={`faq-btn-${index}`}
                      className="flex w-full items-start justify-between gap-4 bg-[#F0520E] text-left transition p-2 rounded-sm text-white"
                      onClick={() => setActiveIndex(open ? null : index)}
                      aria-expanded={open}
                      aria-controls={`faq-content-${index}`}
                    >
                      <span
                        className={`pr-3 font-montserrat text-[16px]  leading-[1.2] text-white md:text-[22px] font-semibold`}
                      >
                        {q}
                      </span>
                    ...
                    >
                      <div className="min-h-0 overflow-hidden">
                        <div className="pb-4 pr-8 pt-0">
                          <p className="text-[14px] leading-relaxed text-black md:text-[16px]">{a}</p>
                        </div>
                      </div>
                    </div>
                  </div>
