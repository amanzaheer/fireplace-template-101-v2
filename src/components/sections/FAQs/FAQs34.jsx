...
export default function FAQs34({ content }) {
    ...
    return (
        <FullContainer className="bg-[#160202] py-10 md:py-14" id="faqs">
            <Container className="px-4 sm:px-6">
                <div className={`mx-auto max-w-6xl ${poppins.className}`}>
                    <h2 className="mb-6 text-center text-3xl font-extrabold tracking-tight text-white md:mb-8 md:text-4xl lg:mb-6 lg:text-5xl">
                        {faqTitle}
                    </h2>

                    <div className="grid items-start gap-0 lg:grid-cols-[420px_1fr] lg:gap-x-3 xl:grid-cols-[460px_1fr]">
                        {faqImageSrc ? (
                            <div className="relative mx-auto flex w-full max-w-full rounded-sm items-center justify-center overflow-hidden  aspect-[4/5] md:max-w-md lg:mx-0 lg:h-[min(452px,48vh)] lg:w-full lg:aspect-auto">
                                <Image
                                    src={faqImageSrc}
                        ...
                        <div
                            className={`min-w-0 w-full border-t border-white text-left text-white ${!faqImageSrc ? "lg:col-span-2" : ""
                                }`}
                        >
                            {faqItems.map((faq, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        {isOpen ? (
                                            <div className="my-2 rounded-xl  p-4 shadow-md sm:my-3 sm:p-5 md:my-4 md:p-8">
                                                <button
                                                    type="button"
                                                    id={`faq-btn-${index}`}
                                                ...
                                                <div
                                                    ...
                                                    className="mt-3 pt-3 flex flex-row items-start gap-4"
                                                >
                                                  
                                                    {faqImageSrc && (
                                                        <div className="relative shrink-0 w-[120px] h-[100px] sm:w-[150px] sm:h-[120px] rounded-lg overflow-hidden">
                                                            <Image
                                                                src={faqImageSrc}
                                                    ...
                                                    {/* Answer text */}
                                                    <p className="text-sm font-normal leading-relaxed text-white sm:text-base md:text-[17px]">
                                                        {answer}
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <button
                                                type="button"
                                                id={`faq-btn-${index}`}
                                                className="flex min-h-[48px] w-full items-start justify-between gap-3 bg-transparent py-4 text-left text-white transition-colors  sm:gap-4 sm:py-5 md:py-6 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#4B2475] focus-visible:ring-offset-2"
