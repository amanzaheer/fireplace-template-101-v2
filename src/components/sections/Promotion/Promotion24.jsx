...
function PromotionGradientCard({
  ...
  return (
    ...
    isMainCard
      ? "bg-gradient-to-b from-[#3F269A] to-[#1463A3]"
      : cardIndex === 0 
        ? "bg-gradient-to-b from-[#3F269A] to-[#1463A3]"  // Middle card - purple to blue
        : "bg-gradient-to-b from-[#3F269A] to-[#1463A3]",
      )}
    >
      <div className="flex flex-col gap-1 sm:gap-1.5">
        ...
        <a
          ...
          className={cn(
            ...
            isMainCard
              ? "bg-[#F2A33c] hover:bg-[#d8d7d6] focus-visible:ring-offset-[#191515]"
...
export default function Promotion24({ content }) {
