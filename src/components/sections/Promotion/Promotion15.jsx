  ...
  const cta = (
    <div className={`flex justify-center items-center shrink-0 ${isMainCard ? "pt-6 md:pt-8" : "pt-4"}`}>
      {isMainCard ? (
        ...
        <a
          href={telHref}
          className={`${rubik.className} inline-flex items-center uppercase font-medium text-sm justify-center gap-2 rounded-md bg-[#f3a008] hover:bg-[#f3a008]/90 text-white px-8 py-3.5 w-fit mx-auto leading-none transition-colors`}
        >
          Call Us Today
...
export default function Promotion15({ content }) {
