...
const PromotionCard = ({
  ...
  const phoneButtonClass =
    "mt-2 mx-auto h-[65px]  w-[260px] inline-flex flex-row items-center justify-center gap-2 rounded-full bg-black text-white shadow-lg transition-all font-inter";
  ...
  return (
    <div
      className={`relative flex flex-col h-full rounded-2xl rounded-b-non p-6 md:p-7 shadow-sm mt-6 ${
        isMainCard
          ? "bg-[#f0520e] text-white md:scale-[1.02]"
...
export default function Promotion22({ content }) {
