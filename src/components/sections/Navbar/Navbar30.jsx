...
export default function Navbar30({ content }) {
        ...
        <div className="flex flex-row items-center justify-end">
          <div className="flex flex-col items-center justify-center gap-1 md:gap-2">
            <div className="text-xs">
              <a
                href={phoneLink}
                className="flex items-center justify-center gap-1.5 rounded-full bg-[#CF1F21] px-3 py-2 text-xs font-semibold text-white shadow transition-all hover:opacity-90 sm:justify-start sm:gap-2 sm:px-4 sm:text-sm lg:px-6 lg:py-3 lg:text-lg"
              >
                <Phone className="h-3.5 w-3.5 lg:h-5 lg:w-5" />
                {phone}
              </a>
            </div>
            <h2 className="hidden font-barlow font-bold leading-none text-[#ED121E]  md:block md:text-[25px] lg:text-lg">
              Call Us Today
            </h2>
          </div>
              ...
              <div className="flex flex-row items-center justify-end">
                <div className="hidden flex-col items-center justify-center gap-1 md:flex md:gap-2">
                  <div className="text-xs">
                    <a
                      href={phoneLink}
                      className="flex items-center justify-center gap-2 rounded-full bg-[#CF1F21] px-6 py-3 text-lg font-semibold text-white shadow transition-all hover:opacity-90 sm:justify-start"
                    >
                      <Phone className="h-5 w-5" />
                      {phone}
                    </a>
                  </div>
                  <h2 className="font-barlow font-bold leading-none text-[#ED121E] md:text-[25px] lg:text-lg">
                    Call Us Today
                  </h2>
                </div>
