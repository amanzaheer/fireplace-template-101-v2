...
export default function Navbar34({ content }) {
    ...
    return (
        ...
        >
            ...
            <FullContainer className="w-full bg-[#BF1309] py-2">
                <Container className="px-0!">
                    <div className="flex items-center justify-between gap-4 px-4 text-white text-sm md:text-base font-medium text-start tracking-wide ">
                        <span>Our Customers Rate Us 5.0 Out of 5.0 ★★★★★ Based on 619+ Reviews!</span>
                        <span className="hidden md:inline">Give us a call to book a London Sweep {phone || "(888)-249-0566"}</span>
                    </div>
                </Container>
            </FullContainer>
            ...
            <Container className="px-0!">
                <div className="h-[86px] md:min-h-[92px] flex items-center">
                    <div className="w-full flex items-center justify-between px-4 md:px-6 lg:px-8 gap-3">
                        ...
                        <div className="hidden md:flex flex-col items-start text-[#1b1d22] shrink-0 tracking-wide">
                            <div className="text-xl font-extrabold text-[#BF1309]">Showroom OPEN:</div>
                            <div className="text-md font-bold">Tuesday - Sunday 11:00am - 4:00 pm</div>
                        </div>

                        <div className="flex items-end text-black shrink-0">
                            <Logo logo={logo} imagePath={imagePath} />
                        </div>

                        <div className="hidden md:flex items-center bg-[#BF1309] p-2 rounded-full shrink-0">
                            <a
                                href={phoneLink}
            ...
            <FullContainer className="w-full bg-[#848484] p-3 ">
                <Container className="px-0!  ">
