...
export default function Navbar31({ content }) {
            ...
            <div className="flex h-full w-full flex-row items-center justify-between gap-3 md:pr-4 lg:pr-6">
                ...
                <div className="flex flex-row items-center justify-end">
                    <div className="hidden flex-col items-end gap-0.5 text-right lg:flex">
                        <a
                            href={phoneLink}
                            className="flex items-center gap-2 text-[#F29100] transition-opacity hover:opacity-80"
                        >
                            <div className="flex w-[53.27px] shrink-0 flex-col items-center justify-center text-[#F29100]">
                                <NavPhoneIcon />
                            </div>
                            <div className="flex flex-col items-start leading-none">
                                <span
                                    className={`${poppins.className} ${NAV_CONTACT_TEXT_CLASS} text-[#F29100]`}
                                >
                                    {phone || "(800) 555-1212"}
                                </span>
                            </div>
