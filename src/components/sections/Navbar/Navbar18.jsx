  ...
  return (
    <a
      ...
      className={cn(
        ...
        "flex hidden sm:flex max-w-full items-center gap-3 rounded-none bg-transparent md:bg-white px-4 py-2  text-black transition-opacity hover:opacity-90",
        className,
      )}
    >
      <span className="flex h-8 w-8 md:h-12 md:w-12 shrink-0 items-center justify-center rounded-full bg-white">
        <Phone className="h-6 w-6 text-[#ff6600] sm:h-6 sm:w-12" strokeWidth={2.25} aria-hidden />
      </span>
      <span className="flex min-w-0 flex-1 items-center justify-start gap-0.5">
        {/* <span className="font-barlow text-[10px] font-bold uppercase leading-none tracking-wide text-white sm:text-xs">
          {callLabel}
        </span> */}
        <span
          className="w-full whitespace-nowrap leading-none truncate text-left text-[14px] font-bold md:text-[27px]"
          style={{ color: "#000" }}
        >
          {phone}
        </span>
...
export default function Navbar18({ content }) {
  ...
  if (!mounted) {
    ...
    >
      ...
      <div className="pointer-events-auto absolute right-0 top-0 z-[110] flex h-full flex-row items-center justify-end bg-transparent ">
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-auto absolute right-0 top-0 z-[110] flex h-full flex-row items-center justify-end bg-transparent ">
          <div className="flex max-w-full items-center sm:max-w-none">
            <NavbarPhoneCta
              href={phoneLink}
              phone={phone}
              callLabel={callUsTodayLabel}
