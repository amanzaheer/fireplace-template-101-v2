...
export default function Navbar27({ content }) {
  ...
  const phoneButtonClass =
    "hidden h-[54px] w-[190px] md:inline-flex flex-col items-center justify-center gap-0.5 text-white shadow-lg transition-all hover:opacity-90";
              ...
              return (
                ...
                >
                  <button
                    type="button"
                    className={cn(
                      "relative inline-flex h-full items-center gap-1 text-[16px] font-normal leading-[100%] tracking-[0%] text-white transition-all hover:font-semibold hover:text-white after:content-[''] after:absolute after:left-0 after:right-0 after:-bottom-2 after:h-[3px] after:opacity-0 after:transition-opacity hover:after:opacity-100",
                  ...
                  <div
                    className={cn(
                      "absolute top-full left-0 w-auto min-w-[300px] bg-black shadow-[0_0_10px_rgba(255,255,255,0.15)] transition-all duration-300 ease-in-out flex flex-col",
                      isOpen
                          ...
                          <Link
                            ...
                            className={cn(
                              ...
                              isActive
                                ...
                                : "bg-black text-white hover:bg-[#da4909] hover:text-white",
                            )}
                          >
                            {child?.title}
                          </Link>
  ...
  if (!mounted) {
    return (
      <FullContainer
      id="navbar"
      className="fixed top-0 left-0 right-0 z-50 w-full border-t-4 border-t-[#da4909] bg-black  py-2 shadow-sm h-[82px] md:h-[84px]"
    >
      <Container>{headerContent}</Container>
       
      <div
        className={cn(
          "lg:hidden py-2 bg-black absolute top-[75px] left-0 right-0 w-full transition-all duration-300",
          isOpen
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    isActive
                      ? "bg-[#da4909] text-white"
                      : "text-white bg-transparent hover:text-[#da4909]",
                  )}
                  onClick={() => {
