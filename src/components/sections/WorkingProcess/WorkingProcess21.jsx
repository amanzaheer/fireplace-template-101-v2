            ...
            {steps.map((step, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <h3
                    className={`${poppins.className} text-[19.04px]  font-medium leading-snug text-[#151515] md:text-[18px]`}
                  >
                    {step?.title}
                  </h3>
                  {step?.description ? (
                    <p
                      className={`${poppins.className} mt-1 text-regular text-'[12.32]'  text-[#1D1D1D]`}
                    >
                      {step.description}
                    </p>
                  ) : null}
