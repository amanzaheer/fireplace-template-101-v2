...
export default function ServiceBenefits15 ({ content }) {
    ...
    <FullContainer id="service_benefits" className="py-0 md:py-8 overflow-hidden ">
      <Container className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-[40%_60%] gap-4">
          ...
          <div className="px-4 md:px-6 py-8 flex flex-col gap-4 rounded-2xl md:translate-x-[-16px]  shadow-[0_0_5px_rgba(0,0,0,0.5)] bg-white z-10 my-7">
            {heading ? (
              <Heading
                text={heading}
