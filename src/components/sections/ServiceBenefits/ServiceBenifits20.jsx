...
export default function ServiceBenefits20({ content }) {
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-8 md:gap-10 lg:gap-14 items-center">
            <div className="relative flex justify-center lg:justify-start">
              <div className="relative w-full max-w-[546px] h-[544px] overflow-hidden rounded-br-[123px] border-l-11 border-b-11 border-[#415FB0] bg-gray-100">
                {imageSrc ? (
                  <Image
            ...
            <div>
              ...
              <div className="mt-7 flex flex-col sm:flex-row gap-8">
                <a
                  href={`tel:${phone}`}
                  className={`${poppins.className} inline-flex items-center justify-center gap-2 bg-[#415FB0] text-white uppercase tracking-wide  px-8 h-[46px] min-w-[219px] text-[19px]  font-bold rounded-full  hover:bg-[#3a8ffb] transition-colors duration-200`}
                >
                  Call Us Today
                ...
                <a
                  href={`tel:${phone}`}
                  className={`${poppins.className} inline-flex items-center justify-center gap-2 bg-[#415FB0] text-white px-6 h-[46px] min-w-[217px] text-xl md:text-[19px] font-bold    leading-none rounded-full hover:bg-[#3a8ffb] transition-colors duration-200`}
                >
                  <Image
