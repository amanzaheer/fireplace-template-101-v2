...
export default function Contact28({ content }) {
    ...
    const formImage = formHead.image ?? null;
                ...
                <div id="quote-form-section">
                    <div className="bg-[#1e73be] gap-0 rounded-[12px] overflow-hidden mb-5">
                        <div className="flex flex-col lg:flex-row lg:min-h-[min(32rem,70vh)] text-white">
                            ...
                            <div className="hidden lg:flex lg:w-[44%] xl:w-[42%] shrink-0 min-h-[450px] relative overflow-hidden">
                                {formImage ? (
                                    <NextImage
                                        src={`/api/image/${formImage}`}
                                        alt="Contact us"
                                        fill
