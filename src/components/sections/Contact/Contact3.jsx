                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-2 md:space-y-2" noValidate>
                                        ...
                                        <div className="pt-2">
                                            <button
                                                ...
                                                className="w-full bg-[#f3a008] text-white py-3.5 px-8 rounded-full transition-all duration-300 font-medium text-xl flex items-center justify-center hover:bg-[#bf1f1f] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 focus:ring-offset-[#1f2226] disabled:opacity-70"
