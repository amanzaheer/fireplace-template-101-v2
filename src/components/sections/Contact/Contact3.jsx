...
const NameInput = memo(({ value, onChange, error }) => (
    <div>
        <input
            ...
            value={value}
            onChange={onChange}
            className={`w-full px-5 py-3 text-base md:text-lg border rounded-xl bg-transparent outline-none text-white placeholder:text-[#bdbdbd] ${error ? "border-red-500" : "border-[#bdbdbd]"} focus:border-gray-300`}
...
const MessageInput = memo(({ value, onChange, error }) => (
    <div>
        <textarea
            ...
            onChange={onChange}
            rows={4}
            className={`w-full px-5 py-3 text-base md:text-lg border rounded-xl bg-transparent outline-none text-white placeholder:text-[#bdbdbd] min-h-[110px] ${error ? "border-red-500" : "border-[#bdbdbd]"} focus:border-gray-300`}
            placeholder="Message"
            required
            aria-invalid={!!error}
        />
...
export default function Contact3({ content }) {
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-2 md:space-y-2" noValidate>
                                        ...
                                        <div className="pt-2">
                                            <button
                                                ...
                                                className={`${rubik.className} w-full bg-[#f59403] text-white py-3.5 px-8 rounded-full transition-all duration-300 font-normal  text-xl flex items-center justify-center hover:bg-[#e29a00] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 focus:ring-offset-[#1f2226] disabled:opacity-70`}
