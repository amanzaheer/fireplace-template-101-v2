...
const NameInput = memo(({ value, onChange, error }) => (
  <div>
    <input
      ...
      value={value}
      onChange={onChange}
      className={`w-full px-5 py-3 text-base md:text-lg border  bg-transparent outline-none text-white placeholder:text-white ${error ? "border-red-500" : "border-white"} focus:border-gray-300`}
...
const MessageInput = memo(({ value, onChange, error }) => (
  <div>
    <textarea
      ...
      onChange={onChange}
      rows={4}
      className={`w-full px-5 py-3 text-base md:text-lg border bg-transparent outline-none text-white placeholder:text-white min-h-[70px] ${error ? "border-red-500" : "border-white"} focus:border-gray-300`}
      placeholder="Message"
      required
      aria-invalid={!!error}
    />
...
export default function Contact32({ content }) {
  ...
  return (
    <FullContainer id="contact-us" className="pb-4 relative mt-9 bg-[#d98200]">
      <Container className="relative z-10">
        <div id="quote-form-section">
          <div className="bg-[#d98200] gap-0 overflow-hidden mb-5  w-full">
