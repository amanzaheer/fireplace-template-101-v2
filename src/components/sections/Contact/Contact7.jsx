...
export default function Contact7({ content }) {
        ...
        <FullContainer id="contact-us" className="pb-4 relative mt-9">
            <Container className="relative z-10">
                <div id="quote-form-section">
                    <div className="bg-[#206ac8] gap-0 rounded-[12px] overflow-hidden mb-5  shadow-lg">
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-2 md:space-y-2" noValidate>
                                        ...
                                        <div className="pt-2">
                                            <button
                                                ...
                                                className={`${rubik.className} w-full bg-white text-black py-3.5 px-8 rounded transition-all duration-300 font-normal  text-xl flex items-center justify-center hover:bg-black hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 focus:ring-offset-[#1f2226] disabled:opacity-70`}
