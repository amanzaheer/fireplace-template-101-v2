...
export default function Contact34({ content }) {
    ...
    <FullContainer id="contact-us" className="relative mt-6 pb-6 sm:mt-9 sm:pb-4">
      <Container className="relative z-10 px-4 sm:px-6">
        <div className="grid grid-cols-1 items-start gap-8 md:grid-cols-2 md:gap-6 lg:gap-10">
          ...
          >
            <div className="mb-2 w-full max-w-[560px] gap-0 overflow-hidden rounded-xl bg-[#E5170B] shadow-lg sm:mb-5 md:max-w-none md:min-h-[560px]">
              <div
