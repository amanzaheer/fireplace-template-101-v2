...
export default function Contact29({ content: contentProp }) {
    ...
    return (
        <section
            id="contact-us"
            className="relative overflow-hidden bg-[#4685ACB2] py-12 md:py-16 lg:py-20"
        >
            <div className="pointer-events-none absolute inset-0 z-0 " aria-hidden>
                {sectionBgUrl ? (
                    ...
                    <div className="h-full w-full bg-[#4685ACB2]" />
                )}
            </div>
            ...
            <div className="relative z-10 mx-auto w-full max-w-[1270px] px-3 md:px-4">
                ...
                >
                    ...
                    <div
                        className={`${poppins.className} mx-auto flex w-full max-w-[439px] min-w-0 flex-col rounded-xl border border-white/15 bg-[#E70A0D] p-5 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.45)] sm:p-6 md:p-7 lg:mx-0 lg:max-w-none lg:w-full`}
                    >
                        {formSubmitted ? (
