...
import QuoteForm33 from "./QuoteForm/QuoteForm33";
...
export default function Banner33({ content }) {
            ...
            <div className="relative z-10 mx-auto flex h-full w-full max-w-[820px] flex-col items-center justify-center px-4 py-10 text-center md:py-14 md:px-8 lg:px-12">
              <div className="mb-3 flex  w-full items-center justify-center gap-2.5">
                {phone ? (
                  <a
                    href={phoneHref}
                    className="inline-flex h-auto min-h-[44px] w-full max-w-[292px] items-center justify-center gap-2 rounded-full border-3 border-white bg-[#da4909] px-9  whitespace-nowrap py-2 shadow-lg text-white hover:opacity-90 sm:gap-2.5 sm:px-5"
                  >
