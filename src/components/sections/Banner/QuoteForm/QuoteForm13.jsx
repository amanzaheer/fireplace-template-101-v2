...
export default function QuoteForm13({
  data: _data,
  form_head,
  ...
  return (
    ...
    >
      {!formSubmitted && (
        <header className="flex w-full shrink-0 flex-col items-center h-[89.4px] gap-1 bg-[#ccde1f] px-4 py-4 text-center">
          <h3
            className="w-full text-balance font-inherit font-bold tracking-tight text-[28px] md:text-[30px]"
            style={{
              color: "#000",
              textAlign: "center",
      ...
      {formSubmitted ? (
        ...
        >
          ...
          <button
            ...
            className="mt-1 flex w-full shrink-0 items-center justify-center rounded-none bg-[#4a2869] px-3 font-inherit font-normal uppercase not-italic transition-opacity hover:opacity-95 disabled:opacity-70"
            style={{
              color: "#FFFFFF",
              fontSize: "37.7px",
              fontWeight: 400,
