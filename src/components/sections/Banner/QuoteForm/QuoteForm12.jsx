...
export default function QuoteForm12({
  ...
  return (
    <div className="bg-white shadow-[0_0_10px_rgba(0,0,0,0.4)] relative font-barlow rounded-[15px] h-fit w-[733px]">
      {!formSubmitted && (
        <>
      ...
      {formSubmitted ? (
        <div className="flex flex-col items-center justify-center text-center py-6  px-4 md:px-7 ">
          ...
          <button
            ...
            className="bg-[#da4909] hover:bg-red-700 text-white py-2 px-6 rounded-md font-medium transition-colors duration-200"
          >
            OK Thanks
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-2.5 text-black  text-base md:text-lg px-2 md:px-2.5 py-2 md:py-3">
          <div className="grid grid-cols-2 gap-[8px]">
            <div>
              ...
              <input
                ...
                className={`w-[333px]  h-[38px] pl-3 py-3 bg-white border rounded-lg md:rounded  outline-none placeholder:text-gray-400 ${
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                onFocus={handleFirstInteraction}
                className={`w-[333px]  h-[38px] pl-3 py-3 bg-white border rounded md:rounded outline-none placeholder:text-gray-400 ${
          ...
          <textarea
            ...
            onFocus={handleFirstInteraction}
            rows={3}
            className={`w-full  h-[66px] pl-3 py-3 max-h-[65px] resize-none   bg-white border rounded md:rounded outline-none placeholder:text-gray-400 ${
          ...
          <button
            ...
            className="w-full bg-[#da4909] text-lg md:text-xl hover:bg-[#c92028]/90 cursor-pointer rounded-full  py-3 px-6 text-white font-medium transition-colors duration-200 flex items-center justify-center gap-2"
          >
            {isSubmitting ? (
              <>
