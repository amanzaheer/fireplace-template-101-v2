...
export default function QuoteForm26({
    ...
    const inputTypography =
        "text-left font-inherit text-base font-normal leading-normal text-[#000] outline-none placeholder:text-left placeholder:font-inherit placeholder:text-base placeholder:font-normal placeholder:text-[#8E8E8E]";
    const quoteFieldFrame =
        "box-border flex w-full max-w-[393.433px] shrink-0 gap-[12.333px]   bg-white px-[12.333px] shadow-none focus:border-[#000] focus:outline-none focus:ring-0 focus-visible:border-[#000]";
    ...
    return (
        <div
            ...
            className={`relative flex h-fit w-full max-w-[439px] min-w-0 flex-col rounded-[18px] bg-[#CC3333] px-6 py-8 shadow-[0_12px_40px_-12px_rgba(0,0,0,0.25)] sm:px-8 ${quoteFormPoppins.className}`}
        >
            {!formSubmitted && (
                <header className="mb-5 flex w-full shrink-0 flex-col items-center gap-2 self-stretch text-center sm:gap-2.5">
                    ...
                    {form_head?.sub_title ? (
                        <p className="w-full max-w-full text-balance text-center text-base font-normal leading-normal text-[#FFFFFF]">
                            {form_head.sub_title}
                        </p>
                    ) : null}
                </header>
            ...
            {formSubmitted ? (
                ...
                >
                    ...
                    <button
                        ...
                        className="flex w-full max-w-[393.433px] shrink-0 items-center justify-center  bg-[#EFCD09] px-[12.333px] font-inherit font-normal uppercase not-italic transition-opacity hover:opacity-95 disabled:opacity-70"
                        style={{
                            color: "#FFFFFF",
                            fontSize: "24.667px",
                            fontWeight: 400,
