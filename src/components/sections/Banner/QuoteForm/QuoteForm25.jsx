...
export default function QuoteForm25({
    data: _data,
    form_head,
    ...
    return (
        <div
            className={`relative flex h-[454px] w-[399px] max-w-[399px] border  min-w-0 flex-col overflow-hidden rounded-[26px] border border-[#d8d8d8] bg-[#d9d9d9] p-0 shadow-[0_10px_30px_rgba(0,0,0,0.32)] ${quoteFormPoppins.className}`}
        >
            {!formSubmitted && (
                <header className="flex w-full shrink-0 flex-col items-center h-[89.4px] gap-1 bg-[#D90209] px-4 py-4 text-center">
                    <h3
                        className="w-full text-balance font-inherit absolute top-8 font-bold tracking-tight text-[28px] md:text-[30px]"
                        style={{
                            color: "#ffffff",
                            textAlign: "center",
            ...
            {formSubmitted ? (
                <div className="flex flex-col items-center justify-center py-6 text-center ">
                    ...
                    <button
                        ...
                        className="rounded-lg bg-[#c7db1f] px-6 py-2 font-normal text-[18px] text-black"
                    >
                        OK Thanks
                    </button>
                </div>
                ...
                <form
                    ...
                    className="flex flex-col gap-3 px-5 pb-5 pt-4 h-[454.5px] font-inherit"
                >
                    <div>
                    ...
                    <button
                        ...
                        className="mt-1 flex w-full shrink-0 items-center justify-center rounded-none bg-black px-3 font-inherit font-normal uppercase not-italic transition-opacity hover:opacity-95 disabled:opacity-70"
                        style={{
                            color: "#FFFFFF",
                            fontSize: "37.7px",
                            fontWeight: 400,
