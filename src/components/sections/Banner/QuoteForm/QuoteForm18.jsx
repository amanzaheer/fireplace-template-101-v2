  ...
  return (
    <div
      className={`relative h-fit font-barlow ${
        isHero
          ? "rounded-2xl border border-white/50 bg-[#DEDEDE] p-2 py-4 md:py-6 md:pb-8 shadow-[0_16px_48px_rgba(0,0,0,0.2)] backdrop-blur-sm md:p-3"
    ...
    >
      {!formSubmitted && (
        <>
          {isHero ? (
            <div className="mb-4 flex bg-[#E55B20] p-1 rounded-lg w-full flex-col ">
              <h3
                className={`${poppins.className} flex min-h-[66px] text-lg md:text-[28px] leading-5 md:leading-[30px]  w-full shrink-0 items-center justify-center self-stretch text-center font-bold not-italic text-white`}
              >
                {form_head?.title}
              </h3>
              {form_head?.sub_title ? (
                <p className={`${inter.className} text-sm md:text-[16px] bg text-center font-medium text-white `}>
                  {form_head?.sub_title}
                </p>
              ) : null}
            </div>
      ...
      {formSubmitted ? (
        ...
        >
          <div className="grid grid-cols-2 gap-[8px]">
            <div>
              ...
              <input
                ...
                className={`w-full rounded-sm text-[16px] border bg-white py-1.5 pl-3 outline-none placeholder:text-gray-500 md:rounded-lg ${
                  fieldErrors.firstName ? "border-[#cf1f21]" : isHero ? "border-white" : "border-white"
                }`}
            ...
            <div>
              ...
              <input
                ...
                onFocus={handleFirstInteraction}
                className={`w-full rounded-sm text-[16px] border bg-white py-1.5 pl-3 outline-none placeholder:text-gray-500 md:rounded-lg ${
                  fieldErrors.lastName ? "border-[#cf1f21]" : isHero ? "border-white" : "border-white"
                }`}
          ...
          <input
            ...
            onFocus={handleFirstInteraction}
            className={`w-full rounded-sm text-[16px] border bg-white py-1.5 pl-3 outline-none placeholder:text-gray-500 md:rounded-lg ${
              fieldErrors.phone ? "border-[#cf1f21]" : isHero ? "border-white" : "border-white"
            }`}
          ...
          <input
            ...
            onFocus={handleFirstInteraction}
            className={`w-full rounded-sm text-[16px] border bg-white py-1.5 pl-3 outline-none placeholder:text-gray-500 md:rounded-lg ${
              fieldErrors.email ? "border-[#cf1f21]" : isHero ? "border-white" : "border-white"
            }`}
          ...
          <textarea
            ...
            className={`w-full max-h-[60px] resize-none rounded-sm text-[16px] border bg-white py-1.5 pl-3 outline-none placeholder:text-gray-500 md:rounded-lg ${
              fieldErrors.message ? "border-[#cf1f21]" : isHero ? "border-white" : "border-white"
            }`}
            placeholder="Message"
            required
          ...
          <button
            ...
            className={`flex w-full cursor-pointer items-center justify-center gap-2 px-6 py-2 font-montserrat font-normal uppercase tracking-wide text-white transition-colors duration-200 ${
              isHero
                ? "rounded-sm bg-[#000] text-md  md:text-base"
