...
export default function QuoteForm16({
  data,
  form_head,
  ...
  return (
    <div className="bg-white shadow-[0_0_10px_rgba(0,0,0,0.4)] relative font-barlow rounded-[15px] h-fit ">
      {!formSubmitted && (
        <>
          <div className="px-2 h-28 md:px-2.5 py-3 relative ">
            <div className="absolute top-0 left-0 w-full z-10 pointer-events-none scale-110 ">
              <svg
                width="360"
                height="96"
                viewBox="0 0 360 96"
              ...
              >
                <path
                  d="M0 0H359.461V67.246L178.508 95.3671L0 67.246V0Z"
                  fill="#234281"
                />
              </svg>
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="absolute bottom-0 left-0 z-20 -translate-y-2"
              >
                <path
                  d="M13.4492 20.1738L0 0L13.4492 1.83398V20.1738Z"
                  fill="#4970BF"
                />
              </svg>
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="absolute bottom-0 right-0 z-20 -translate-y-2"
              >
                <path
                  d="M0.000315154 19.5625L14.0605 7.52358e-06L3.68698e-05 1.834L0.000315154 19.5625Z"
                  fill="#4970BF"
                />
              </svg>
            </div>

            <h3 className={`${poppins.className} text-24px absolute top-0 left-0 w-full z-50 md:text-[34px] leading-7 md:leading-[30px] px-2.5 font-bold text-center mb-2`}
              style={{ color: "#FF7146" }}
            >
              {form_head?.title}
            </h3>
      ...
      {formSubmitted ? (
        <div className="flex flex-col items-center justify-center text-center py-6  px-4 md:px-7 mt-20">
          ...
          <button
            ...
            className="bg-[#FF4811] hover:bg-red-700 text-white py-2 px-6 rounded-none font-medium transition-colors duration-200"
          >
            OK Thanks
          </button>
        </div>
      ) : (
        <form onSubmit={handleSubmit} className="space-y-2.5 text-black  text-base md:text-lg px-2 md:px-2.5 py-2 md:py-3 md:pt-20 ">
          ...
          <textarea
            ...
            onFocus={handleFirstInteraction}
            rows={3}
            className={`w-full pl-3 py-3 max-h-[65px] resize-none  border  rounded-lg md:rounded-xl outline-none placeholder:text-gray-400 ${fieldErrors.message ? "border-red-500" : "border-[#bdbdbd]"
              }`}
            placeholder="Message"
            required
          ...
          <button
            ...
            className="w-full bg-[#FF4811] text-lg md:text-xl hover:bg-[#c92028]/90 cursor-pointer rounded-none  py-3 px-6 text-white font-medium transition-colors duration-200 flex items-center justify-center gap-2"
          >
            {isSubmitting ? (
              <>
