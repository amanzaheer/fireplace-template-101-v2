...
export default function QuoteForm3({
  ...
  return (
    <div className="w-full bg-black border-3 rounded-2xl border-[#D90209] shadow-[0_0_18px_rgba(0,0,0,0.35)] relative font-barlow h-fit">
      {!formSubmitted && (
        <>
      ...
      {formSubmitted ? (
        <div className="flex flex-col items-center justify-center text-center py-6 px-4 md:px-7">
          ...
          <button
            ...
            className="bg-[#D90209] hover:bg-[#c40108] text-white py-2 px-6 rounded-md font-medium transition-colors duration-200"
          >
            OK Thanks
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-2.5 text-black text-base md:text-lg px-4 md:px-5 pb-5 md:pb-6">
          ...
          {/* ROW 1: FirstName | Phone | Email (3 columns) */}
          <div className="grid grid-cols-3 gap-[8px]">
            <div>
              ...
              <input
                ...
                className={`w-full pl-3 py-3 bg-transparent border rounded-xl outline-none text-white placeholder:text-white/80 ${
                  fieldErrors.firstName ? "border-red-500" : "border-white/85"
                }`}
            ...
            <div>
              ...
              <input
                ...
                onFocus={handleFirstInteraction}
                className={`w-full pl-3 py-3 bg-transparent border rounded-xl outline-none text-white placeholder:text-white/80 ${
                  fieldErrors.phone ? "border-red-500" : "border-white/85"
                }`}
          ...
          <div>
            ...
            <input
              ...
              onFocus={handleFirstInteraction}
              className={`w-full pl-3 py-3 bg-transparent border rounded-xl outline-none text-white placeholder:text-white/80 ${
                fieldErrors.lastName ? "border-red-500" : "border-white/85"
              }`}
          ...
          <button
            ...
            className={`${poppins.className} w-full bg-[#D90209] text-base md:text-[20px] hover:bg-[#c40108] cursor-pointer rounded-xl py-3 px-6 text-white font-medium transition-colors duration-200 flex items-center justify-center gap-2 uppercase`}
          >
            {isSubmitting ? (
              <>
