...
export default function QuoteForm22({
  data: _data,
  form_head,
  ...
  return (
    <div
      className={`relative flex h-[454px] w-[399px] max-w-[399px]  min-w-0 flex-col overflow-hidden rounded-[26px]  bg-[#d9d9d9] p-0 shadow-[0_10px_30px_rgba(0,0,0,0.32)] ${quoteFormPoppins.className}`}
    >
      {!formSubmitted && (
        <header className="flex w-full shrink-0 flex-col items-center h-[89.4px] gap-1 bg-[#f0520e] px-4 py-4 text-center">
          <h3
      ...
      {formSubmitted ? (
        <div className="flex flex-col items-center justify-center py-6 text-center ">
          ...
          <button
            ...
            className="rounded-lg bg-[#f0520e] text-white px-6 py-2 font-normal text-[18px]"
          >
            OK Thanks
          </button>
        </div>
