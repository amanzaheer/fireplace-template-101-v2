...
export default function QuoteForm33({
    data,
    form_head,
    ...
    const inputClass = (hasError) =>
        `w-full min-w-0 min-h-[42px] rounded-lg border bg-white pl-3 pr-3 text-sm outline-none placeholder:text-sm placeholder:text-black/70 sm:min-h-[38px] sm:text-base sm:placeholder:text-base ${hasError ? "border-red-500" : "border-[#bdbdbd]"
        } focus:border-[#da4909]`;
                ...
                >
                    ...
                    <div className="min-w-0">
                        ...
                        <textarea
                            ...
                            onFocus={handleFirstInteraction}
                            rows={3}
                            className={`w-full min-w-0 min-h-[72px] max-h-[100px] resize-none rounded-lg border bg-white py-2 pl-3 pr-3 text-sm outline-none placeholder:text-sm placeholder:text-black/70 sm:min-h-[64px] sm:max-h-[80px] sm:text-base sm:placeholder:text-base ${fieldErrors.message ? "border-red-500" : "border-[#bdbdbd]"
                                } focus:border-[#da4909]`}
                            placeholder="Message"
                            required
