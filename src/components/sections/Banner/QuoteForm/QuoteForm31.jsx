...
export default function QuoteForm31({
  data,
  form_head,
  ...
  return (
    <div className="bg-[#FFFFFF]  relative font-barlow  h-fit ">
      {!formSubmitted && (
        <>
        <div className="px-4 md:px-5 pt-5 md:pt-6 pb-2">
          <h3 className={`${poppins.className} text-2xl md:text-[25px] text-black leading-none px-1 font-extrabold text-start mb-2 uppercase`}>
            {form_head?.title}
          </h3>
        </div>
      ...
      {formSubmitted ? (
        <div className="flex flex-col items-center justify-center text-center py-6 px-4 md:px-7">
          ...
          <p className="text-[#212020] max-w-md mb-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-2.5 text-black text-base md:text-lg px-4 md:px-5 pb-5 md:pb-6">
          <div className="grid grid-cols-2 gap-[8px]">
            <div>
              ...
              <input
                ...
                className={`w-full pl-3 py-3 bg-transparent border border-black rounded-xl outline-none text-black placeholder:text-black/80 ${
                  fieldErrors.firstName ? "border-red-500" : " border-2 border-black"
                }`}
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                onFocus={handleFirstInteraction}
                className={`w-full pl-3 py-3 bg-transparent border rounded-xl outline-none text-black placeholder:text-black/80 ${
                  fieldErrors.lastName ? "border-red-500" : "border-2 border-black"
                }`}
          ...
          <input
            ...
            onFocus={handleFirstInteraction}
            className={`w-full pl-3 py-3 bg-transparent border rounded-xl outline-none text-black placeholder:text-black/80 ${
              fieldErrors.phone ? "border-red-500" : "border-2 border-black"
            }`}
          ...
          />
          {fieldErrors.phone && (
            <div className="text-red-600 text-sm font-medium">{fieldErrors.phone}</div>
          )}
          ...
          <input
            ...
            onChange={handleChange}
            onFocus={handleFirstInteraction}
            className={`w-full pl-3 py-[11px] bg-transparent border rounded-xl outline-none text-black  placeholder:text-black/80 ${
              fieldErrors.email ? "border-red-500" : "border-2 border-black"
            }`}
          ...
          />
          {fieldErrors.email && (
            <div className="text-red-600 text-sm font-medium">{fieldErrors.email}</div>
          )}
          ...
          <textarea
            ...
            onFocus={handleFirstInteraction}
            rows={3}
            className={`w-full pl-3 py-[11px] max-h-[70px] resize-none bg-transparent border rounded-xl outline-none text-black  placeholder:text-black/80 ${
              fieldErrors.message ? "border-red-500" : "border-2 border-black"
            }`}
            placeholder="Message"
            required
          ...
          <button
            ...
            className={`${poppins.className} w-full bg-[#FF9D0A] text-base md:text-[20px]  cursor-pointer rounded-xl py-3 px-6 text-black font-medium transition-colors duration-200 flex items-center justify-center gap-2 uppercase`}
          >
            {isSubmitting ? (
              <>
