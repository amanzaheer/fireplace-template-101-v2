...
export default function Banner27({ content }) {
  ...
  return (
    <FullContainer className="relative w-auto overflow-x-hidden bg-[#0A0909] mt-[57.8px] md:mt-[84px] min-h-[580px] md:h-[600px] md:overflow-hidden">
      <div
      ...
      >
        <div
          className=" h-[200px] w-[126px]  sm:h-[72px] sm:w-[150px] md:h-[450px] md:w-[188px]"
          style={{
        ...
        <div
          className="absolute inset-y-0 left-0 h-[300px]  w-[100px] lg:h-full lg:w-full "
          style={{
        ...
        <div className="grid gap-5 sm:gap-8 lg:items-center lg:grid-cols-2 lg:gap-24">
          <div className="min-w-0 max-w-full pb-2 max-md:pr-0 md:pl-60 md:pb-4 lg:pl-4 xl:pl-25">
            ...
            <a
              ...
              className={` ${poppin.className} block max-w-full break-words font-medium leading-none text-white text-[clamp(1.375rem,5vw,1.75rem)] sm:text-[28px] lg:text-[30px]`}
            >
              {phone}
            </a>
            ...
            {showTagline ? (
              <p
                className={`${poppin.className} mt-2 max-w-full text-base font-medium not-italic text-white sm:text-lg md:text-xl lg:max-w-[26rem] lg:text-2xl xl:text-[30px]`}
            ...
            <h1
              className={`${poppin.className} mt-4 text-[clamp(1.375rem,5.5vw,1.75rem)] font-medium uppercase leading-none text-[#FF2A2A] sm:text-[28px] md:text-[36px]`}
            >
              {headingTop}
            </h1>
            {headingBottom ? (
              <div className="mt-[9px] box-border w-fit max-w-full min-w-0  px-3 py-2 sm:px-4 sm:py-2.5 md:px-4 md:py-3">
                <span
                  className={`${poppin.className} block max-w-full text-left font-medium uppercase not-italic leading-none  tracking-tight text-white text-[clamp(1.25rem,5vw,1.875rem)] sm:text-3xl md:text-[44px]`}
                  style={{ color: "#FF2A2A" }}
                >
                  {headingBottom}
                </span>
