...
export default function Banner15({ content }) {
  ...
  return (
    <FullContainer id="banner" className="relative w-full overflow-hidden bg-white mt-8">
      <div className="relative h-full w-full py-6 lg:py-0 max-h-full overflow-hidden lg:h-[580px] lg:max-h-[580px]">
        <Image
          src={imageSrc}
          alt={headline || "Hero"}
          priority
         className="absolute right-0 top-0 h-full w-full lg:w-[45%] object-cover object-right [clip-path:polygon(15%_0%,_100%_0%,_100%_100%,_0%_100%)]"
          width={10000}
          height={580}
        ...
        <Container className="relative mx-auto mt-8 w-full max-w-7xl px-4 sm:px-6 lg:px-8 z-10 flex flex-col items-center justify-center h-full">
          <div className="grid items-start gap-10 lg:grid-cols-[1fr_min(420px,38vw)] lg:gap-12 xl:gap-0 w-full  ">
            <div className="max-w-2xl text-white md:max-w-none flex flex-col items-center lg:items-start justify-center gap-4 w-full">
              <h1 className="font-montserrat font-bold leading-tight tracking-tight text-4xl md:text-5xl lg:text-[52px] lg:leading-[58px] text-black">
                  ...
                  {(() => {
                    ...
                    return (
                      <>
                        ...
                        <FiveStars className="" starClassName="text-[#E55B20] text-[16px]!" />
                        </div>
              ...
              <p className="max-w-xl font-barlow font-medium items-center justify-center text-center md:text-left leading-relaxed text-black text-[20px] lg:text-[23px]">
                {subhead}
              </p>
              ...
              <ul className="grid max-w-lg grid-cols-1 gap-x-10 gap-y-1.5 sm:grid-cols-2 sm:gap-y-2">
                {features.slice(0, 6).map((feature, idx) => {
                  ...
                  return (
                    <li
                      key={`${text}-${idx}`}
                      className="flex items-start gap-3 font-barlow font-medium text-black text-[15px] lg:text-[18px]"
                    >
                      <Icon className="mt-0.5 h-5 w-5 shrink-0 text-[#E55B20]" strokeWidth={2} aria-hidden />
                      <span>{text}</span>
                    </li>
                  );
                })}
              ...
              <div className="">
                ...
                >
                  <BannerCtaIcon />
                  <span
                    className={`${rubik.className} text-[32px] font-bold not-italic leading-normal text-[#E55B20]`}
                  >
                    {phone}
                  </span>
                </Link>
            ...
            <div className="w-full max-w-[400px] mt-10 justify-self-center px-0 md:px-5 lg:justify-self-end lg:px-8">
              <QuoteForm18
                data={{}}
                form_head={form_head}
      ...
      <div
        className="relative z-10 w-full border-t bg-[#F0520E] border-black/10 px-4 py-6 sm:px-6 lg:px-10"
        ...
        <Container className="mx-auto  flex w-full max-w-7xl px-4 sm:px-6 lg:px-8 flex-col items-center justify-between gap-4 md:flex-row md:gap-6">
          ...
          <Link
                ...
                >
                  <BannerCtaIcon />
                  <span
                    className={`${rubik.className} text-[24px] lg:text-[32px] font-bold not-italic leading-normal text-[#F0520E]`}
                  >
                    {phone}
                  </span>
                </Link>
