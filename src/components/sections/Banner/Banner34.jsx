...
import QuoteForm34 from "./QuoteForm/QuoteForm34";
...
export default function Banner34({ content }) {
    ...
    return (
        <FullContainer
            id="banner"
            className={`z-10 relative isolate -mt-[50px] w-full overflow-hidden bg-transparent px-0 pt-0 md:-mt-[15px] md:pt-0 ${poppins.className}`}
        >
            <div className="w-full">
                <div className="relative w-full min-h-[460px] overflow-hidden bg-black pb-8 lg:min-h-[520px] lg:pb-12">
                    {image ? (
                        <Image
                            src={image}
                    ...
                    <div className="relative z-10 mx-auto flex min-h-0 w-full max-w-[1270px] flex-col items-start gap-10 px-3 py-10 md:px-4 md:py-14">
                        <div className="relative z-10 flex h-full w-full flex-col items-center justify-center text-center md:items-start md:text-left">
                            {(headingLine1 || headingAccent) && (
                                <div className="self-center md:self-start">
                                    {headingLine1 ? (
                                        <h2 className="text-center text-2xl font-bold uppercase leading-tight text-white sm:text-3xl md:text-left md:text-4xl lg:text-5xl">
                                            {headingLine1}
                                        </h2>
                                    ) : null}

                                    {headingAccent ? (
                                        <p className="mt-2 text-center text-base font-medium text-white/80 md:text-left">
                                            {headingAccent}
                                        </p>
                                    ) : null}
                                </div>
                                        ...
                                        return (
                                            ...
                                            >
                                                <span className="mt-0.5 inline-flex shrink-0 items-center justify-center rounded">
                                                    <IconComponent className="h-5 w-5 text-[#BF1309]" aria-hidden />
                                                </span>
                            ...
                            {phone ? (
                                <a
                                    href={phoneHref}
                                    className="group mb-0 mt-6 inline-flex w-auto max-w-max flex-nowrap items-center justify-center gap-3 self-center rounded-full border border-white/25 bg-[#BF1309] px-5 py-3 text-white shadow-[inset_0_4px_6px_rgba(0,0,0,0.15),inset_0_-4px_6px_rgba(0,0,0,0.15)] transition-opacity hover:opacity-95 sm:justify-start sm:px-8 sm:py-3.5 md:mt-8 md:self-start lg:mt-8"
                                >
                                    <Image
