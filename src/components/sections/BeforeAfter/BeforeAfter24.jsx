  ...
  return (
    ...
    >
      <div className="absolute inset-0">
        ...
        />
        <div
          className={`${isHover ? "opacity-100" : "opacity-0"} transition-all duration-500 absolute top-14 right-4 bg-white font-bold bg-opacity-70 text-black px-3 py-1 rounded z-10`}
        >
          After
        </div>
      </div>
      ...
      >
        <div className="relative w-full h-full">
          ...
          />
          <div
            className={`${isHover ? "opacity-100" : "opacity-0"} transition-all duration-500 absolute top-14 left-4 bg-white font-bold bg-opacity-70 text-black px-3 py-1 rounded`}
          >
            Before
          </div>
        </div>
...
export default function BeforeAfter24({ content }) {
