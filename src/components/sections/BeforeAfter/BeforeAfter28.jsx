    ...
    return (
        ...
        >
            <div className="absolute inset-0">
                ...
                />
                <div
                    className={` "opacity-100" : "opacity-0"} transition-all duration-500 absolute bottom-7 right-9 bg-black bg-opacity-70 text-white px-3 py-1 rounded z-10`}
                >
                    After
                </div>
            </div>
            ...
            >
                <div className="relative w-full h-full">
                    ...
                    />
                    <div
                        className={` "opacity-100" : "opacity-0"} transition-all duration-500 absolute bottom-7 left-9 bg-black bg-opacity-70 z-10 text-white px-3 py-1 rounded`}
                    >
                        Before
                    </div>
                </div>
...
export default function BeforeAfter28({ content }) {
