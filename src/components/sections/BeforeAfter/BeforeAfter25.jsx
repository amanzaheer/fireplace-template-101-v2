...
function BeforeAfterSlider({ beforeImage, afterImage, beforeAlt, afterAlt }) {
    ...
    return (
        <div
            className="group relative mx-auto aspect-[175/117] w-full max-w-[353px] overflow-hidden rounded-[42px] border border-white "
...
export default function BeforeAfter25({ content }) {
    ...
    return (
        <FullContainer id="before_after" className="bg-gradient-to-b from-[#BF1309] to-[#020202]">
            <Container className="pb-16 pt-10 md:pb-40 md:pt-14">
                <h2 className="mx-auto mb-5 max-w-4xl text-center text-3xl font-bold leading-tight tracking-tight text-white md:mb-7 md:text-4xl lg:text-5xl">
                    {title}
                </h2>
