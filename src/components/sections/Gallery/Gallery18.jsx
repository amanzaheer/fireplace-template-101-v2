...
const galleryPhoneButtonWrap =
  "[&_button]:!min-h-[48px]  [&_button]:!rounded [&_button]:!border-0 [&_button]:!bg-black [&_button]:!px-7 [&_button]:!py-3 [&_button]:!text-sm [&_button]:!font-bold [&_button]:!uppercase [&_button]:!tracking-[0.14em] [&_button]:!text-white [&_button]:!shadow-[0_10px_25px_rgba(0,0,0,0.2)] [&_button]:hover:!bg-black [&_button]:!transition-all [&_svg]:!text-black";
...
export default function Gallery18({ content }) {
  ...
  return (
    <FullContainer
      id="gallery"
      className="relative overflow-hidden bg-black py-12 md:py-20"
    >
        ...
        {title ? (
          <h2
            className={cn(
              ...
              "mx-auto mb-5 max-w-4xl text-center text-[34px] font-regular uppercase tracking-[0.06em] leading-[1.2] text-white md:text-[36px]",
            )}
          >
            {title}
          </h2>
        ...
        {html ? (
          <div
            className={cn(
              ...
              "prose mx-auto mb-4 max-w-3xl w-full text-center text-[16px] leading-[1.75] text-white",
              ...
              "[&_a]:!text-white [&_strong]:!font-semibold [&_strong]:!text-white",
            )}
          ...
          <div className="mt-10 grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-10">
            {files.map((fileName, index) => {
              ...
              return (
                <div
                  key={index}
                  className="group relative overflow-hidden rounded-[24px]  bg-[#FF0011]  p-3  backdrop-blur-sm transition-transform duration-300 hover:-translate-y-1"
                >
