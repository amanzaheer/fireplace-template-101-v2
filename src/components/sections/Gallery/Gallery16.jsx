...
export default function Gallery16({ content }) {
      ...
      <Container>
        <div className="max-w-6xl mx-auto">
          {title ? (
            ...
            className={cn(
              poppins.className,
              "text-[34px] md:text-[100px] lg:text-[60px]",
              "font-extrabold text-black ",
              "text-center mb-5 md:mb-8"
            )}
          >
            {title}
          </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10">
              {files.map((fileName, index) => {
                ...
                return (
                  ...
                  >
                    <div className="w-full overflow-hidden rounded-none bg-gray-100 shadow-sm border border-[#e5e7eb]">
                    ...
                    {phone ? (
                      <a
                        href={`tel:${phone}`}
                        className={`${rubik.className} inline-flex items-center rounded-none justify-center gap-2 rounded-full bg-[#FF4811] text-white font-semibold text-base md:text-lg px-8 py-3 min-w-[220px] shadow-md hover:bg-[#FF4811] transition-colors duration-200`}
                      >
