                ...
                return (
                  ...
                  >
                    ...
                    {phone ? (
                      <a
                        href={`tel:${phone}`}
                        className="inline-flex items-center justify-center gap-2  bg-[#f59e0b]  text-white font-semibold text-base md:text-lg px-8 py-3 min-w-[220px] shadow-md hover:bg-[#2a2a2a] transition-colors duration-200"
                      >
