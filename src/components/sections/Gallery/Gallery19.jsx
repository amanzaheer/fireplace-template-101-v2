...
const galleryPhoneButtonWrap =
  "[&_button]:!min-h-[48px] [&_button]:!rounded-full [&_button]:!border-0 [&_button]:!bg-[#cc3333] [&_button]:!px-7 [&_button]:!py-3 [&_button]:!text-sm [&_button]:!font-bold [&_button]:!uppercase [&_button]:!tracking-[0.14em] [&_button]:!text-white [&_button]:!shadow-[0_10px_25px_rgba(0,0,0,0.2)] [&_button]:hover:!bg-[#b71f1f] [&_button]:!transition-all [&_svg]:!text-white";
...
export default function Gallery19({ content }) {
          ...
          <div className="mt-10 grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-10">
            {files.map((fileName, index) => {
              ...
              return (
                <div
                  key={index}
                  className="group relative overflow-hidden rounded-[24px] border border-black/10 bg-white/90 p-3 shadow-[0_14px_35px_rgba(0,0,0,0.12)] backdrop-blur-sm transition-transform duration-300 hover:-translate-y-1"
                >
