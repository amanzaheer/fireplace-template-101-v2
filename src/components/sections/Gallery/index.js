...
import Gallery23 from "./Gallery23";
const variants = {
  Gallery1,
  Gallery2,
  Gallery3,
...
export default function Gallery({ variant, content }) {
  const name = variant ?? "Gallery23";
  const Component = variants[name] ?? Gallery23;
  return <Component content={content} />;
}

export { Gallery1, Gallery2, Gallery3, Gallery4, Gallery5, Gallery6, Gallery8, Gallery7, Gallery9, Gallery10, Gallery11, Gallery12, Gallery13, Gallery14, Gallery15, Gallery16, Gallery17, Gallery19, Gallery20, Gallery21, Gallery23,    variants };
