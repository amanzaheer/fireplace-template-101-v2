...
const galleryPhoneButtonWrap =
  "[&_button]:!min-h-[48px] [&_button]:!rounded-full [&_button]:!border-0 [&_button]:!bg-[#d62828] [&_button]:!px-7 [&_button]:!py-3 [&_button]:!text-sm [&_button]:!font-bold [&_button]:!uppercase [&_button]:!tracking-[0.14em] [&_button]:!text-white [&_button]:!shadow-[0_10px_25px_rgba(0,0,0,0.2)] [&_button]:hover:!bg-[#b71f1f] [&_button]:!transition-all [&_svg]:!text-white";
...
export default function Gallery11({ content }) {
